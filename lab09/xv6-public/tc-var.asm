...
int main(int argc, char *argv[]) {
  ...
  15:	83 ec 30             	sub    $0x30,%esp
    printf(1, "Calling Process Print VAR value: %d\n", VAR);
  18:	ff 35 b4 0b 00 00    	push   0xbb4
  1e:	68 2c 08 00 00       	push   $0x82c
  23:	6a 01                	push   $0x1
  25:	e8 d6 04 00 00       	call   500 <printf>
    init_lock(&lock);
  2a:	c7 04 24 b0 0b 00 00 	movl   $0xbb0,(%esp)
  31:	e8 ed 03 00 00       	call   423 <init_lock>
    for(int i=0;i<N;i++) {
  ...
  49:	83 c6 04             	add    $0x4,%esi
        create_thread(increment, &thread_num[i]);
  4c:	68 a0 00 00 00       	push   $0xa0
  51:	e8 ea 02 00 00       	call   340 <create_thread>
    for(int i=0;i<N;i++) {
  ...
  5c:	75 e2                	jne    40 <main+0x40>
    ...
    for(int i=0;i<N;i++) {
        join();
  5e:	e8 b8 03 00 00       	call   41b <join>
  63:	e8 b3 03 00 00       	call   41b <join>
  68:	e8 ae 03 00 00       	call   41b <join>
  6d:	e8 a9 03 00 00       	call   41b <join>
  72:	e8 a4 03 00 00       	call   41b <join>
    }

    printf(1, "All threads joined, VAR value: %d\n", VAR);
  77:	83 ec 04             	sub    $0x4,%esp
  7a:	ff 35 b4 0b 00 00    	push   0xbb4
  80:	68 54 08 00 00       	push   $0x854
  85:	6a 01                	push   $0x1
  87:	e8 74 04 00 00       	call   500 <printf>
    exit();
  8c:	e8 e2 02 00 00       	call   373 <exit>
  91:	66 90                	xchg   %ax,%ax
  93:	66 90                	xchg   %ax,%ax
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
...
void increment(int *thread_rank) {
  ...
  a3:	53                   	push   %ebx
  a4:	bb e8 03 00 00       	mov    $0x3e8,%ebx
  a9:	83 ec 04             	sub    $0x4,%esp
  ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    acquire_lock(&lock);
  b0:	83 ec 0c             	sub    $0xc,%esp
  b3:	68 b0 0b 00 00       	push   $0xbb0
  b8:	e8 6e 03 00 00       	call   42b <acquire_lock>
    release_lock(&lock);
  bd:	c7 04 24 b0 0b 00 00 	movl   $0xbb0,(%esp)
    VAR++;
  c4:	83 05 b4 0b 00 00 01 	addl   $0x1,0xbb4
    release_lock(&lock);
  cb:	e8 63 03 00 00       	call   433 <release_lock>
    for(int i=0; i<1000; i++){
  d0:	83 c4 10             	add    $0x10,%esp
  d3:	83 eb 01             	sub    $0x1,%ebx
  d6:	75 d8                	jne    b0 <increment+0x10>
    printf(1, "Thread Rank: %d, VAR: %d\n", *thread_rank, VAR);
  d8:	8b 45 08             	mov    0x8(%ebp),%eax
  db:	ff 35 b4 0b 00 00    	push   0xbb4
  e1:	ff 30                	push   (%eax)
  e3:	68 08 08 00 00       	push   $0x808
  e8:	6a 01                	push   $0x1
  ea:	e8 11 04 00 00       	call   500 <printf>
    exit();
  ef:	e8 7f 02 00 00       	call   373 <exit>
  f4:	66 90                	xchg   %ax,%ax
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
  fa:	66 90                	xchg   %ax,%ax
 ...
 229:	31 db                	xor    %ebx,%ebx
{
 ...
 235:	56                   	push   %esi
 236:	6a 00                	push   $0x0
 238:	e8 4e 01 00 00       	call   38b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 21 01 00 00       	call   3b3 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 24 01 00 00       	call   3cb <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 ea 00 00 00       	call   39b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 34b:	e8 d0 03 00 00       	call   720 <malloc>
 ...
 35a:	e8 b4 00 00 00       	call   413 <clone>
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 49b:	0f b6 92 d0 08 00 00 	movzbl 0x8d0(%edx),%edx
 ...
 509:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 574:	ff 24 85 78 08 00 00 	jmp    *0x878(,%eax,4)
 ...
 680:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 685:	bb 22 08 00 00       	mov    $0x822,%ebx
 ...
 691:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6cf:	5b                   	pop    %ebx
  freep = p;
 6d0:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 6d7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76b:	3b 05 b8 0b 00 00    	cmp    0xbb8,%eax
 ...
 78e:	e8 fd fe ff ff       	call   690 <free>
  return freep;
 793:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 7bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 ...
 7cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 bc 0b 00 00       	mov    $0xbbc,%eax
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 7e6:	0b 00 00 
    base.s.size = 0;
 7e9:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 7f0:	00 00 00 
    if(p->s.size >= nunits){
