...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 18 39 00 00       	call   3943 <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      32:	52                   	push   %edx
      33:	52                   	push   %edx
      34:	68 0c 55 00 00       	push   $0x550c
      39:	6a 01                	push   $0x1
      3b:	e8 50 3a 00 00       	call   3a90 <printf>
    exit();
      40:	e8 be 38 00 00       	call   3903 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 ed 38 00 00       	call   3943 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 cd 38 00 00       	call   392b <close>
  ...
  exit();
     10d:	e8 f1 37 00 00       	call   3903 <exit>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 29 38 00 00       	call   396b <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 1d 38 00 00       	call   3973 <chdir>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 f1 37 00 00       	call   3973 <chdir>
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b3:	e8 4b 37 00 00       	call   3903 <exit>
    ...
    exit();
     1ca:	e8 34 37 00 00       	call   3903 <exit>
    ...
    exit();
     1e1:	e8 1d 37 00 00       	call   3903 <exit>
    ...
    exit();
     1f8:	e8 06 37 00 00       	call   3903 <exit>
...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 e0 36 00 00       	call   38fb <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 36 37 00 00       	call   396b <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 26 37 00 00       	call   3973 <chdir>
    ...
    exit();
     26c:	e8 92 36 00 00       	call   3903 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 8e 36 00 00       	call   390b <wait>
  printf(stdout, "exitiput test ok\n");
     ...
     2a6:	e8 e5 37 00 00       	call   3a90 <printf>
      exit();
     2ab:	e8 53 36 00 00       	call   3903 <exit>
    ...
    exit();
     2c2:	e8 3c 36 00 00       	call   3903 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     ...
     2d4:	e8 b7 37 00 00       	call   3a90 <printf>
      exit();
     2d9:	e8 25 36 00 00       	call   3903 <exit>
     ...
     2eb:	e8 a0 37 00 00       	call   3a90 <printf>
      exit();
     2f0:	e8 0e 36 00 00       	call   3903 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     31d:	e8 49 36 00 00       	call   396b <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 c9 35 00 00       	call   38fb <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 fc 35 00 00       	call   3943 <open>
    if(fd >= 0){
  ...
  sleep(1);
     ...
     373:	6a 01                	push   $0x1
     375:	e8 19 36 00 00       	call   3993 <sleep>
  if(unlink("oidir") != 0){
  ...
  wait();
     38d:	e8 79 35 00 00       	call   390b <wait>
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 4e 35 00 00       	call   3903 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
    ...
    exit();
     3c7:	e8 37 35 00 00       	call   3903 <exit>
    ...
    exit();
     3de:	e8 20 35 00 00       	call   3903 <exit>
    ...
    exit();
     3f5:	e8 09 35 00 00       	call   3903 <exit>
...
00000400 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 1f 35 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 f7 34 00 00       	call   392b <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 95 3e 00 00       	push   $0x3e95
     43d:	e8 01 35 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     473:	e8 8b 34 00 00       	call   3903 <exit>
    ...
    exit();
     48a:	e8 74 34 00 00       	call   3903 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 8a 34 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 33 34 00 00       	call   3923 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 17 34 00 00       	call   3923 <write>
  ...
  close(fd);
     ...
     536:	e8 f0 33 00 00       	call   392b <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 df 3e 00 00       	push   $0x3edf
     544:	e8 fa 33 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 9f 33 00 00       	call   391b <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     5a0:	e8 86 33 00 00       	call   392b <close>
  if(unlink("small") < 0){
  ...
  printf(stdout, "small file test ok\n");
    ...
    exit();
     619:	e8 e5 32 00 00       	call   3903 <exit>
    ...
    exit();
     630:	e8 ce 32 00 00       	call   3903 <exit>
    ...
    exit();
     647:	e8 b7 32 00 00       	call   3903 <exit>
    ...
    exit();
     65e:	e8 a0 32 00 00       	call   3903 <exit>
...
00000670 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 aa 32 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 5a 32 00 00       	call   3923 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 40 32 00 00       	call   392b <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 27 40 00 00       	push   $0x4027
     6f4:	e8 4a 32 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 e1 31 00 00       	call   391b <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 d5 31 00 00       	call   392b <close>
  if(unlink("big") < 0){
  ...
  printf(stdout, "big files ok\n");
     ...
     799:	e8 f2 32 00 00       	call   3a90 <printf>
      exit();
     79e:	e8 60 31 00 00       	call   3903 <exit>
      printf(stdout, "read content of block %d is %d\n",
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 2c 4e 00 00       	push   $0x4e2c
     7aa:	ff 35 98 5e 00 00    	push   0x5e98
     7b0:	e8 db 32 00 00       	call   3a90 <printf>
      exit();
     7b5:	e8 49 31 00 00       	call   3903 <exit>
     ...
     7c9:	e8 c2 32 00 00       	call   3a90 <printf>
      exit();
     7ce:	e8 30 31 00 00       	call   3903 <exit>
     ...
     7e4:	e8 a7 32 00 00       	call   3a90 <printf>
        exit();
     7e9:	e8 15 31 00 00       	call   3903 <exit>
    ...
    exit();
     800:	e8 fe 30 00 00       	call   3903 <exit>
    ...
    exit();
     817:	e8 e7 30 00 00       	call   3903 <exit>
    ...
    exit();
     82e:	e8 d0 30 00 00       	call   3903 <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     84c:	68 4c 4e 00 00       	push   $0x4e4c
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 b8 30 00 00       	call   3943 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 98 30 00 00       	call   392b <close>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d1:	68 78 4e 00 00       	push   $0x4e78
...
000008f0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     90d:	e8 59 30 00 00       	call   396b <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 4d 30 00 00       	call   3973 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 35 30 00 00       	call   3973 <chdir>
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     983:	e8 7b 2f 00 00       	call   3903 <exit>
    ...
    exit();
     99a:	e8 64 2f 00 00       	call   3903 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
    ...
    exit();
     9b1:	e8 4d 2f 00 00       	call   3903 <exit>
    ...
    exit();
     9c8:	e8 36 2f 00 00       	call   3903 <exit>
...
000009d0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9f2:	e8 44 2f 00 00       	call   393b <exec>
    ...
    exit();
     a12:	e8 ec 2e 00 00       	call   3903 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a5f:	e8 c7 2e 00 00       	call   392b <close>
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a73:	e8 a3 2e 00 00       	call   391b <read>
     ...
     ac7:	68 ee 40 00 00       	push   $0x40ee
     acc:	6a 01                	push   $0x1
     ace:	e8 bd 2f 00 00       	call   3a90 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ae6:	e8 40 2e 00 00       	call   392b <close>
     ...
     b21:	e8 fd 2d 00 00       	call   3923 <write>
    ...
    exit();
     b38:	e8 c6 2d 00 00       	call   3903 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b4b:	e8 db 2d 00 00       	call   392b <close>
    wait();
     b50:	e8 b6 2d 00 00       	call   390b <wait>
  printf(1, "pipe1 ok\n");
     b55:	5a                   	pop    %edx
     b56:	59                   	pop    %ecx
     b57:	68 13 41 00 00       	push   $0x4113
     b5c:	6a 01                	push   $0x1
     b5e:	e8 2d 2f 00 00       	call   3a90 <printf>
     b63:	83 c4 10             	add    $0x10,%esp
     b66:	e9 6b ff ff ff       	jmp    ad6 <pipe1+0xb6>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b6b:	56                   	push   %esi
     b6c:	53                   	push   %ebx
     b6d:	68 fc 40 00 00       	push   $0x40fc
     b72:	6a 01                	push   $0x1
     b74:	e8 17 2f 00 00       	call   3a90 <printf>
      exit();
     b79:	e8 85 2d 00 00       	call   3903 <exit>
    printf(1, "pipe() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 d1 40 00 00       	push   $0x40d1
     b85:	6a 01                	push   $0x1
     b87:	e8 04 2f 00 00       	call   3a90 <printf>
    exit();
     b8c:	e8 72 2d 00 00       	call   3903 <exit>
    printf(1, "fork() failed\n");
     b91:	50                   	push   %eax
     b92:	50                   	push   %eax
     b93:	68 1d 41 00 00       	push   $0x411d
     b98:	6a 01                	push   $0x1
     b9a:	e8 f1 2e 00 00       	call   3a90 <printf>
    exit();
     b9f:	e8 5f 2d 00 00       	call   3903 <exit>
        printf(1, "pipe1 oops 1\n");
     ba4:	57                   	push   %edi
     ba5:	57                   	push   %edi
     ba6:	68 e0 40 00 00       	push   $0x40e0
     bab:	6a 01                	push   $0x1
     bad:	e8 de 2e 00 00       	call   3a90 <printf>
        exit();
     bb2:	e8 4c 2d 00 00       	call   3903 <exit>
...
00000bc0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bc9:	68 2c 41 00 00       	push   $0x412c
     bce:	6a 01                	push   $0x1
     bd0:	e8 bb 2e 00 00       	call   3a90 <printf>
  pid1 = fork();
     bd5:	e8 21 2d 00 00       	call   38fb <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bea:	e8 0c 2d 00 00       	call   38fb <fork>
  ...
  pipe(pfds);
     ...
     c06:	50                   	push   %eax
     c07:	e8 07 2d 00 00       	call   3913 <pipe>
  pid3 = fork();
     c0c:	e8 ea 2c 00 00       	call   38fb <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c20:	e8 06 2d 00 00       	call   392b <close>
    if(write(pfds[1], "x", 1) != 1)
     c25:	83 c4 0c             	add    $0xc,%esp
     c28:	6a 01                	push   $0x1
     c2a:	68 f1 46 00 00       	push   $0x46f1
     c2f:	ff 75 e4             	push   -0x1c(%ebp)
     c32:	e8 ec 2c 00 00       	call   3923 <write>
    ...
    close(pfds[1]);
     ...
     c49:	e8 dd 2c 00 00       	call   392b <close>
  ...
  close(pfds[0]);
     ...
     c86:	e8 a0 2c 00 00       	call   392b <close>
  printf(1, "kill... ");
     c8b:	58                   	pop    %eax
     c8c:	5a                   	pop    %edx
     c8d:	68 5d 41 00 00       	push   $0x415d
     c92:	6a 01                	push   $0x1
     c94:	e8 f7 2d 00 00       	call   3a90 <printf>
  kill(pid1);
     c99:	89 1c 24             	mov    %ebx,(%esp)
     c9c:	e8 92 2c 00 00       	call   3933 <kill>
  kill(pid2);
     ca1:	89 34 24             	mov    %esi,(%esp)
     ca4:	e8 8a 2c 00 00       	call   3933 <kill>
  kill(pid3);
     ca9:	89 3c 24             	mov    %edi,(%esp)
     cac:	e8 82 2c 00 00       	call   3933 <kill>
  printf(1, "wait... ");
     cb1:	59                   	pop    %ecx
     cb2:	5b                   	pop    %ebx
     cb3:	68 66 41 00 00       	push   $0x4166
     cb8:	6a 01                	push   $0x1
     cba:	e8 d1 2d 00 00       	call   3a90 <printf>
  wait();
     cbf:	e8 47 2c 00 00       	call   390b <wait>
  wait();
     cc4:	e8 42 2c 00 00       	call   390b <wait>
  wait();
     cc9:	e8 3d 2c 00 00       	call   390b <wait>
  printf(1, "preempt ok\n");
     cce:	5e                   	pop    %esi
     ccf:	5f                   	pop    %edi
     cd0:	68 6f 41 00 00       	push   $0x416f
     cd5:	6a 01                	push   $0x1
     cd7:	e8 b4 2d 00 00       	call   3a90 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cea:	68 4a 41 00 00       	push   $0x414a
     cef:	6a 01                	push   $0x1
     cf1:	e8 9a 2d 00 00       	call   3a90 <printf>
     cf6:	83 c4 10             	add    $0x10,%esp
     cf9:	eb e4                	jmp    cdf <preempt+0x11f>
      printf(1, "preempt write error");
     cfb:	83 ec 08             	sub    $0x8,%esp
     cfe:	68 36 41 00 00       	push   $0x4136
     d03:	6a 01                	push   $0x1
     d05:	e8 86 2d 00 00       	call   3a90 <printf>
...
00000d20 <exitwait>:
{
    ...
    if(pid){
     d30:	74 68                	je     d9a <exitwait+0x7a>
      if(wait() != pid){
     d32:	e8 d4 2b 00 00       	call   390b <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d40:	e8 b6 2b 00 00       	call   38fb <fork>
    ...
    if(pid < 0){
     ...
     d4e:	68 d9 4c 00 00       	push   $0x4cd9
     d53:	6a 01                	push   $0x1
     d55:	e8 36 2d 00 00       	call   3a90 <printf>
      return;
     ...
     d6b:	68 7b 41 00 00       	push   $0x417b
     d70:	6a 01                	push   $0x1
     d72:	e8 19 2d 00 00       	call   3a90 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d84:	68 8b 41 00 00       	push   $0x418b
     d89:	6a 01                	push   $0x1
     d8b:	e8 00 2d 00 00       	call   3a90 <printf>
     ...
     d99:	c3                   	ret
      exit();
     d9a:	e8 64 2b 00 00       	call   3903 <exit>
     d9f:	90                   	nop
...
00000da0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     daa:	68 98 41 00 00       	push   $0x4198
     daf:	6a 01                	push   $0x1
     db1:	e8 da 2c 00 00       	call   3a90 <printf>
  ppid = getpid();
     db6:	e8 c8 2b 00 00       	call   3983 <getpid>
     dbb:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dbd:	e8 39 2b 00 00       	call   38fb <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ddc:	e8 cf 2e 00 00       	call   3cb0 <malloc>
    ...
    while(m1){
     ...
     df5:	8b 36                	mov    (%esi),%esi
      free(m1);
     df7:	50                   	push   %eax
     df8:	e8 23 2e 00 00       	call   3c20 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     e0c:	e8 9f 2e 00 00       	call   3cb0 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e1b:	50                   	push   %eax
     e1c:	e8 ff 2d 00 00       	call   3c20 <free>
    printf(1, "mem ok\n");
     e21:	58                   	pop    %eax
     e22:	5a                   	pop    %edx
     e23:	68 bc 41 00 00       	push   $0x41bc
     e28:	6a 01                	push   $0x1
     e2a:	e8 61 2c 00 00       	call   3a90 <printf>
    exit();
     e2f:	e8 cf 2a 00 00       	call   3903 <exit>
     e34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e38:	83 ec 08             	sub    $0x8,%esp
     e3b:	68 a2 41 00 00       	push   $0x41a2
     e40:	6a 01                	push   $0x1
     e42:	e8 49 2c 00 00       	call   3a90 <printf>
      kill(ppid);
     e47:	89 1c 24             	mov    %ebx,(%esp)
     e4a:	e8 e4 2a 00 00       	call   3933 <kill>
      exit();
     e4f:	e8 af 2a 00 00       	call   3903 <exit>
     ...
     e5d:	5d                   	pop    %ebp
    wait();
     e5e:	e9 a8 2a 00 00       	jmp    390b <wait>
...
00000e70 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e79:	68 c4 41 00 00       	push   $0x41c4
     e7e:	6a 01                	push   $0x1
     e80:	e8 0b 2c 00 00       	call   3a90 <printf>
  unlink("sharedfd");
     e85:	c7 04 24 d3 41 00 00 	movl   $0x41d3,(%esp)
     e8c:	e8 c2 2a 00 00       	call   3953 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e91:	5b                   	pop    %ebx
     e92:	5e                   	pop    %esi
     e93:	68 02 02 00 00       	push   $0x202
     e98:	68 d3 41 00 00       	push   $0x41d3
     e9d:	e8 a1 2a 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  pid = fork();
     eb7:	e8 3f 2a 00 00       	call   38fb <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f16:	e8 f0 29 00 00       	call   390b <wait>
  close(fd);
  ...
  close(fd);
     ...
     f24:	e8 02 2a 00 00       	call   392b <close>
  fd = open("sharedfd", 0);
     f29:	58                   	pop    %eax
     f2a:	5a                   	pop    %edx
     f2b:	6a 00                	push   $0x0
     f2d:	68 d3 41 00 00       	push   $0x41d3
     f32:	e8 0c 2a 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f5c:	e8 ba 29 00 00       	call   391b <read>
  ...
  close(fd);
     ...
     f96:	e8 90 29 00 00       	call   392b <close>
  unlink("sharedfd");
     f9b:	c7 04 24 d3 41 00 00 	movl   $0x41d3,(%esp)
     fa2:	e8 ac 29 00 00       	call   3953 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fc0:	68 dc 41 00 00       	push   $0x41dc
     fc5:	6a 01                	push   $0x1
     fc7:	e8 c4 2a 00 00       	call   3a90 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fda:	68 a0 4e 00 00       	push   $0x4ea0
     fdf:	6a 01                	push   $0x1
     fe1:	e8 aa 2a 00 00       	call   3a90 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     ff4:	68 ec 4e 00 00       	push   $0x4eec
     ff9:	6a 01                	push   $0x1
     ffb:	e8 90 2a 00 00       	call   3a90 <printf>
    return;
    ...
    100a:	c3                   	ret
    exit();
    100b:	e8 f3 28 00 00       	call   3903 <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
    1010:	53                   	push   %ebx
    1011:	52                   	push   %edx
    1012:	68 e9 41 00 00       	push   $0x41e9
    1017:	6a 01                	push   $0x1
    1019:	e8 72 2a 00 00       	call   3a90 <printf>
    exit();
    101e:	e8 e0 28 00 00       	call   3903 <exit>
    ...
    1036:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    103b:	c7 45 d8 fe 41 00 00 	movl   $0x41fe,-0x28(%ebp)
    1042:	c7 45 dc 47 43 00 00 	movl   $0x4347,-0x24(%ebp)
    1049:	c7 45 e0 4b 43 00 00 	movl   $0x434b,-0x20(%ebp)
    1050:	c7 45 e4 01 42 00 00 	movl   $0x4201,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1057:	68 04 42 00 00       	push   $0x4204
    105c:	6a 01                	push   $0x1
    105e:	e8 2d 2a 00 00       	call   3a90 <printf>
    ...
    106d:	56                   	push   %esi
    106e:	e8 e0 28 00 00       	call   3953 <unlink>
    pid = fork();
    1073:	e8 83 28 00 00       	call   38fb <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1091:	e8 75 28 00 00       	call   390b <wait>
    1096:	31 f6                	xor    %esi,%esi
    1098:	e8 6e 28 00 00       	call   390b <wait>
    109d:	e8 69 28 00 00       	call   390b <wait>
    10a2:	e8 64 28 00 00       	call   390b <wait>
    fname = names[i];
    ...
    10b8:	6a 00                	push   $0x0
    10ba:	50                   	push   %eax
    10bb:	e8 83 28 00 00       	call   3943 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10e0:	e8 36 28 00 00       	call   391b <read>
    ...
    111a:	51                   	push   %ecx
    111b:	e8 0b 28 00 00       	call   392b <close>
    if(total != 12*500){
    ...
    1135:	e8 19 28 00 00       	call   3953 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    114e:	68 42 42 00 00       	push   $0x4242
    1153:	6a 01                	push   $0x1
    1155:	e8 36 29 00 00       	call   3a90 <printf>
}
    ...
    1168:	68 25 42 00 00       	push   $0x4225
    116d:	6a 01                	push   $0x1
    116f:	e8 1c 29 00 00       	call   3a90 <printf>
          exit();
    1174:	e8 8a 27 00 00       	call   3903 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1179:	83 ec 08             	sub    $0x8,%esp
    117c:	68 02 02 00 00       	push   $0x202
    1181:	56                   	push   %esi
    1182:	e8 bc 27 00 00       	call   3943 <open>
      if(fd < 0){
    ...
    11bb:	56                   	push   %esi
    11bc:	e8 62 27 00 00       	call   3923 <write>
    ...
    11ce:	75 de                	jne    11ae <fourfiles+0x17e>
      exit();
    11d0:	e8 2e 27 00 00       	call   3903 <exit>
        printf(1, "create failed\n");
    11d5:	51                   	push   %ecx
    11d6:	51                   	push   %ecx
    11d7:	68 9f 44 00 00       	push   $0x449f
    11dc:	6a 01                	push   $0x1
    11de:	e8 ad 28 00 00       	call   3a90 <printf>
        exit();
    11e3:	e8 1b 27 00 00       	call   3903 <exit>
    11e8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    11ef:	00 
      printf(1, "fork failed\n");
    11f0:	83 ec 08             	sub    $0x8,%esp
    11f3:	68 d9 4c 00 00       	push   $0x4cd9
    11f8:	6a 01                	push   $0x1
    11fa:	e8 91 28 00 00       	call   3a90 <printf>
      exit();
    11ff:	e8 ff 26 00 00       	call   3903 <exit>
      printf(1, "wrong length %d\n", total);
    1204:	50                   	push   %eax
    1205:	57                   	push   %edi
    1206:	68 31 42 00 00       	push   $0x4231
    120b:	6a 01                	push   $0x1
    120d:	e8 7e 28 00 00       	call   3a90 <printf>
      exit();
    1212:	e8 ec 26 00 00       	call   3903 <exit>
          printf(1, "write failed %d\n", n);
    1217:	52                   	push   %edx
    1218:	50                   	push   %eax
    1219:	68 14 42 00 00       	push   $0x4214
    121e:	6a 01                	push   $0x1
    1220:	e8 6b 28 00 00       	call   3a90 <printf>
          exit();
    1225:	e8 d9 26 00 00       	call   3903 <exit>
    ...
    1235:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "createdelete test\n");
    123b:	68 50 42 00 00       	push   $0x4250
    1240:	6a 01                	push   $0x1
    1242:	e8 49 28 00 00       	call   3a90 <printf>
    1247:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    124a:	e8 ac 26 00 00       	call   38fb <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1267:	e8 9f 26 00 00       	call   390b <wait>
  for(i = 0; i < N; i++){
    126c:	31 ff                	xor    %edi,%edi
    126e:	8d 75 c8             	lea    -0x38(%ebp),%esi
    wait();
    1271:	e8 95 26 00 00       	call   390b <wait>
    1276:	e8 90 26 00 00       	call   390b <wait>
    127b:	e8 8b 26 00 00       	call   390b <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12b0:	6a 00                	push   $0x0
    12b2:	56                   	push   %esi
    12b3:	e8 8b 26 00 00       	call   3943 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 59 26 00 00       	call   392b <close>
  ...
  printf(1, "createdelete ok\n");
    ...
    1344:	50                   	push   %eax
    1345:	56                   	push   %esi
    1346:	68 3c 4f 00 00       	push   $0x4f3c
    134b:	6a 01                	push   $0x1
    134d:	e8 3e 27 00 00       	call   3a90 <printf>
        exit();
    1352:	e8 ac 25 00 00       	call   3903 <exit>
    ...
    137e:	56                   	push   %esi
    137f:	e8 bf 25 00 00       	call   3943 <open>
        if(fd < 0){
    ...
    1392:	50                   	push   %eax
    1393:	e8 93 25 00 00       	call   392b <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13aa:	75 c4                	jne    1370 <createdelete+0x140>
      exit();
    13ac:	e8 52 25 00 00       	call   3903 <exit>
    ...
    13c9:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13cc:	56                   	push   %esi
    13cd:	e8 81 25 00 00       	call   3953 <unlink>
    ...
    13d9:	52                   	push   %edx
    13da:	52                   	push   %edx
    13db:	68 51 3e 00 00       	push   $0x3e51
    13e0:	6a 01                	push   $0x1
    13e2:	e8 a9 26 00 00       	call   3a90 <printf>
            exit();
    13e7:	e8 17 25 00 00       	call   3903 <exit>
    13ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f0:	83 ec 04             	sub    $0x4,%esp
    13f3:	56                   	push   %esi
    13f4:	68 18 4f 00 00       	push   $0x4f18
    13f9:	6a 01                	push   $0x1
    13fb:	e8 90 26 00 00       	call   3a90 <printf>
        exit();
    1400:	e8 fe 24 00 00       	call   3903 <exit>
      printf(1, "fork failed\n");
    1405:	83 ec 08             	sub    $0x8,%esp
    1408:	68 d9 4c 00 00       	push   $0x4cd9
    140d:	6a 01                	push   $0x1
    140f:	e8 7c 26 00 00       	call   3a90 <printf>
      exit();
    1414:	e8 ea 24 00 00       	call   3903 <exit>
          printf(1, "create failed\n");
    1419:	83 ec 08             	sub    $0x8,%esp
    141c:	68 9f 44 00 00       	push   $0x449f
    1421:	6a 01                	push   $0x1
    1423:	e8 68 26 00 00       	call   3a90 <printf>
          exit();
    1428:	e8 d6 24 00 00       	call   3903 <exit>
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    143d:	6a 01                	push   $0x1
    143f:	e8 4c 26 00 00       	call   3a90 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1444:	5b                   	pop    %ebx
    1445:	5e                   	pop    %esi
    1446:	68 02 02 00 00       	push   $0x202
    144b:	68 85 42 00 00       	push   $0x4285
    1450:	e8 ee 24 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 b1 24 00 00       	call   3923 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 b1 24 00 00       	call   392b <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 85 42 00 00       	push   $0x4285
    1483:	e8 bb 24 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 b1 24 00 00       	call   3953 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 84 24 00 00       	call   3943 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 12 24 00 00       	call   3923 <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 09 24 00 00       	call   392b <close>
  unlink("unlinkread");
    1522:	c7 04 24 85 42 00 00 	movl   $0x4285,(%esp)
    1529:	e8 25 24 00 00       	call   3953 <unlink>
  printf(1, "unlinkread ok\n");
    152e:	58                   	pop    %eax
    152f:	5a                   	pop    %edx
    1530:	68 2d 43 00 00       	push   $0x432d
    1535:	6a 01                	push   $0x1
    1537:	e8 54 25 00 00       	call   3a90 <printf>
}
    ...
    154d:	6a 01                	push   $0x1
    154f:	e8 3c 25 00 00       	call   3a90 <printf>
    exit();
    1554:	e8 aa 23 00 00       	call   3903 <exit>
    printf(1, "unlinkread write failed\n");
    1559:	51                   	push   %ecx
    155a:	51                   	push   %ecx
    155b:	68 14 43 00 00       	push   $0x4314
    1560:	6a 01                	push   $0x1
    1562:	e8 29 25 00 00       	call   3a90 <printf>
    exit();
    1567:	e8 97 23 00 00       	call   3903 <exit>
    printf(1, "unlinkread wrong data\n");
    156c:	53                   	push   %ebx
    156d:	53                   	push   %ebx
    156e:	68 fd 42 00 00       	push   $0x42fd
    1573:	6a 01                	push   $0x1
    1575:	e8 16 25 00 00       	call   3a90 <printf>
    exit();
    157a:	e8 84 23 00 00       	call   3903 <exit>
    printf(1, "unlinkread read failed");
    157f:	56                   	push   %esi
    1580:	56                   	push   %esi
    1581:	68 e6 42 00 00       	push   $0x42e6
    1586:	6a 01                	push   $0x1
    1588:	e8 03 25 00 00       	call   3a90 <printf>
    exit();
    158d:	e8 71 23 00 00       	call   3903 <exit>
    printf(1, "unlink unlinkread failed\n");
    1592:	50                   	push   %eax
    1593:	50                   	push   %eax
    1594:	68 c8 42 00 00       	push   $0x42c8
    1599:	6a 01                	push   $0x1
    159b:	e8 f0 24 00 00       	call   3a90 <printf>
    exit();
    15a0:	e8 5e 23 00 00       	call   3903 <exit>
    printf(1, "open unlinkread failed\n");
    15a5:	50                   	push   %eax
    15a6:	50                   	push   %eax
    15a7:	68 b0 42 00 00       	push   $0x42b0
    15ac:	6a 01                	push   $0x1
    15ae:	e8 dd 24 00 00       	call   3a90 <printf>
    exit();
    15b3:	e8 4b 23 00 00       	call   3903 <exit>
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 0a 23 00 00       	call   3923 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 fd 22 00 00       	call   392b <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 4a 43 00 00       	push   $0x434a
    1635:	68 46 43 00 00       	push   $0x4346
    163a:	e8 24 23 00 00       	call   3963 <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 fc 22 00 00       	call   3953 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 46 43 00 00       	push   $0x4346
    1660:	e8 de 22 00 00       	call   3943 <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 c4 22 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1699:	50                   	push   %eax
    169a:	e8 7c 22 00 00       	call   391b <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 77 22 00 00       	call   392b <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 4a 43 00 00       	push   $0x434a
    16bb:	68 4a 43 00 00       	push   $0x434a
    16c0:	e8 9e 22 00 00       	call   3963 <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 76 22 00 00       	call   3953 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 46 43 00 00       	push   $0x4346
    16e4:	68 4a 43 00 00       	push   $0x434a
    16e9:	e8 75 22 00 00       	call   3963 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 5c 22 00 00       	call   3963 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1716:	6a 01                	push   $0x1
    1718:	e8 73 23 00 00       	call   3a90 <printf>
}
    ...
    172c:	6a 01                	push   $0x1
    172e:	e8 5d 23 00 00       	call   3a90 <printf>
    exit();
    1733:	e8 cb 21 00 00       	call   3903 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1738:	50                   	push   %eax
    1739:	50                   	push   %eax
    173a:	68 c8 43 00 00       	push   $0x43c8
    173f:	6a 01                	push   $0x1
    1741:	e8 4a 23 00 00       	call   3a90 <printf>
    exit();
    1746:	e8 b8 21 00 00       	call   3903 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 84 4f 00 00       	push   $0x4f84
    1752:	6a 01                	push   $0x1
    1754:	e8 37 23 00 00       	call   3a90 <printf>
    exit();
    1759:	e8 a5 21 00 00       	call   3903 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    175e:	50                   	push   %eax
    175f:	50                   	push   %eax
    1760:	68 aa 43 00 00       	push   $0x43aa
    1765:	6a 01                	push   $0x1
    1767:	e8 24 23 00 00       	call   3a90 <printf>
    exit();
    176c:	e8 92 21 00 00       	call   3903 <exit>
    printf(1, "read lf2 failed\n");
    1771:	51                   	push   %ecx
    1772:	51                   	push   %ecx
    1773:	68 99 43 00 00       	push   $0x4399
    1778:	6a 01                	push   $0x1
    177a:	e8 11 23 00 00       	call   3a90 <printf>
    exit();
    177f:	e8 7f 21 00 00       	call   3903 <exit>
    printf(1, "open lf2 failed\n");
    1784:	53                   	push   %ebx
    1785:	53                   	push   %ebx
    1786:	68 88 43 00 00       	push   $0x4388
    178b:	6a 01                	push   $0x1
    178d:	e8 fe 22 00 00       	call   3a90 <printf>
    exit();
    1792:	e8 6c 21 00 00       	call   3903 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 5c 4f 00 00       	push   $0x4f5c
    179e:	6a 01                	push   $0x1
    17a0:	e8 eb 22 00 00       	call   3a90 <printf>
    exit();
    17a5:	e8 59 21 00 00       	call   3903 <exit>
    printf(1, "link lf1 lf2 failed\n");
    17aa:	51                   	push   %ecx
    17ab:	51                   	push   %ecx
    17ac:	68 73 43 00 00       	push   $0x4373
    17b1:	6a 01                	push   $0x1
    17b3:	e8 d8 22 00 00       	call   3a90 <printf>
    exit();
    17b8:	e8 46 21 00 00       	call   3903 <exit>
    printf(1, "write lf1 failed\n");
    17bd:	50                   	push   %eax
    17be:	50                   	push   %eax
    17bf:	68 61 43 00 00       	push   $0x4361
    17c4:	6a 01                	push   $0x1
    17c6:	e8 c5 22 00 00       	call   3a90 <printf>
    exit();
    17cb:	e8 33 21 00 00       	call   3903 <exit>
    ...
    17d5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17de:	68 f1 43 00 00       	push   $0x43f1
    17e3:	6a 01                	push   $0x1
    17e5:	e8 a6 22 00 00       	call   3a90 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1819:	53                   	push   %ebx
    181a:	e8 24 21 00 00       	call   3943 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1829:	83 c6 01             	add    $0x1,%esi
      close(fd);
    182c:	50                   	push   %eax
    182d:	e8 f9 20 00 00       	call   392b <close>
    1832:	83 c4 10             	add    $0x10,%esp
      wait();
    1835:	e8 d1 20 00 00       	call   390b <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    184c:	53                   	push   %ebx
    184d:	e8 01 21 00 00       	call   3953 <unlink>
    pid = fork();
    1852:	e8 a4 20 00 00       	call   38fb <fork>
    if(pid && (i % 3) == 1){
    ...
    1878:	53                   	push   %ebx
    1879:	e8 c5 20 00 00       	call   3943 <open>
      if(fd < 0){
    ...
    188c:	53                   	push   %ebx
    188d:	68 04 44 00 00       	push   $0x4404
    1892:	6a 01                	push   $0x1
    1894:	e8 f7 21 00 00       	call   3a90 <printf>
        exit();
    1899:	e8 65 20 00 00       	call   3903 <exit>
  ...
  for(i = 0; i < 40; i++){
    18a3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18a6:	53                   	push   %ebx
    18a7:	68 01 44 00 00       	push   $0x4401
    18ac:	e8 b2 20 00 00       	call   3963 <link>
    18b1:	83 c4 10             	add    $0x10,%esp
      wait();
    18b4:	e8 52 20 00 00       	call   390b <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    18d3:	5f                   	pop    %edi
    18d4:	6a 00                	push   $0x0
    18d6:	68 0e 46 00 00       	push   $0x460e
    18db:	8d 7d b0             	lea    -0x50(%ebp),%edi
    18de:	e8 60 20 00 00       	call   3943 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18f5:	57                   	push   %edi
    18f6:	56                   	push   %esi
    18f7:	e8 1f 20 00 00       	call   391b <read>
    ...
    1943:	53                   	push   %ebx
    1944:	68 01 44 00 00       	push   $0x4401
    1949:	e8 15 20 00 00       	call   3963 <link>
    194e:	83 c4 10             	add    $0x10,%esp
      exit();
    1951:	e8 ad 1f 00 00       	call   3903 <exit>
  ...
  close(fd);
    ...
    1963:	56                   	push   %esi
    1964:	e8 c2 1f 00 00       	call   392b <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	53                   	push   %ebx
    198d:	e8 c1 1f 00 00       	call   3953 <unlink>
      unlink(file);
    1992:	89 1c 24             	mov    %ebx,(%esp)
    1995:	e8 b9 1f 00 00       	call   3953 <unlink>
      unlink(file);
    ...
    19af:	74 a0                	je     1951 <concreate+0x181>
      wait();
    19b1:	e8 55 1f 00 00       	call   390b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19c8:	e8 2e 1f 00 00       	call   38fb <fork>
    ...
    19f4:	6a 00                	push   $0x0
    19f6:	53                   	push   %ebx
    19f7:	e8 47 1f 00 00       	call   3943 <open>
    19fc:	89 04 24             	mov    %eax,(%esp)
    19ff:	e8 27 1f 00 00       	call   392b <close>
      close(open(file, 0));
    1a04:	58                   	pop    %eax
    1a05:	5a                   	pop    %edx
    1a06:	6a 00                	push   $0x0
    1a08:	53                   	push   %ebx
    1a09:	e8 35 1f 00 00       	call   3943 <open>
    1a0e:	89 04 24             	mov    %eax,(%esp)
    1a11:	e8 15 1f 00 00       	call   392b <close>
      close(open(file, 0));
    1a16:	59                   	pop    %ecx
    1a17:	58                   	pop    %eax
    1a18:	6a 00                	push   $0x0
    1a1a:	53                   	push   %ebx
    1a1b:	e8 23 1f 00 00       	call   3943 <open>
    1a20:	89 04 24             	mov    %eax,(%esp)
    1a23:	e8 03 1f 00 00       	call   392b <close>
      close(open(file, 0));
    1a28:	58                   	pop    %eax
    1a29:	5a                   	pop    %edx
    1a2a:	6a 00                	push   $0x0
    1a2c:	53                   	push   %ebx
    1a2d:	e8 11 1f 00 00       	call   3943 <open>
    1a32:	89 04 24             	mov    %eax,(%esp)
    1a35:	e8 f1 1e 00 00       	call   392b <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a4b:	68 56 44 00 00       	push   $0x4456
    1a50:	6a 01                	push   $0x1
    1a52:	e8 39 20 00 00       	call   3a90 <printf>
}
    ...
    1a62:	68 d9 4c 00 00       	push   $0x4cd9
    1a67:	6a 01                	push   $0x1
    1a69:	e8 22 20 00 00       	call   3a90 <printf>
      exit();
    1a6e:	e8 90 1e 00 00       	call   3903 <exit>
      close(fd);
    1a73:	83 ec 0c             	sub    $0xc,%esp
    1a76:	50                   	push   %eax
    1a77:	e8 af 1e 00 00       	call   392b <close>
    ...
    1a8a:	50                   	push   %eax
    1a8b:	68 20 44 00 00       	push   $0x4420
    1a90:	6a 01                	push   $0x1
    1a92:	e8 f9 1f 00 00       	call   3a90 <printf>
        exit();
    1a97:	e8 67 1e 00 00       	call   3903 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a9c:	51                   	push   %ecx
    1a9d:	51                   	push   %ecx
    1a9e:	68 a8 4f 00 00       	push   $0x4fa8
    1aa3:	6a 01                	push   $0x1
    1aa5:	e8 e6 1f 00 00       	call   3a90 <printf>
    exit();
    1aaa:	e8 54 1e 00 00       	call   3903 <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1aaf:	83 ec 04             	sub    $0x4,%esp
    1ab2:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1ab5:	50                   	push   %eax
    1ab6:	68 39 44 00 00       	push   $0x4439
    1abb:	6a 01                	push   $0x1
    1abd:	e8 ce 1f 00 00       	call   3a90 <printf>
        exit();
    1ac2:	e8 3c 1e 00 00       	call   3903 <exit>
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 ab 1f 00 00       	call   3a90 <printf>
  unlink("x");
    1ae5:	c7 04 24 f1 46 00 00 	movl   $0x46f1,(%esp)
    1aec:	e8 62 1e 00 00       	call   3953 <unlink>
  pid = fork();
    1af1:	e8 05 1e 00 00       	call   38fb <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 21 1e 00 00       	call   3953 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b61:	68 f1 46 00 00       	push   $0x46f1
    1b66:	e8 d8 1d 00 00       	call   3943 <open>
    1b6b:	89 04 24             	mov    %eax,(%esp)
    1b6e:	e8 b8 1d 00 00       	call   392b <close>
  ...
  if(pid)
    ...
    wait();
    1b82:	e8 84 1d 00 00       	call   390b <wait>
  printf(1, "linkunlink ok\n");
    1b87:	83 ec 08             	sub    $0x8,%esp
    1b8a:	68 79 44 00 00       	push   $0x4479
    1b8f:	6a 01                	push   $0x1
    1b91:	e8 fa 1e 00 00       	call   3a90 <printf>
}
    ...
    1bad:	e8 b1 1d 00 00       	call   3963 <link>
    ...
    1bc1:	6a 01                	push   $0x1
    1bc3:	e8 c8 1e 00 00       	call   3a90 <printf>
    exit();
    1bc8:	e8 36 1d 00 00       	call   3903 <exit>
    exit();
    1bcd:	e8 31 1d 00 00       	call   3903 <exit>
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 9b 1e 00 00       	call   3a90 <printf>
  unlink("bd");
    1bf5:	c7 04 24 95 44 00 00 	movl   $0x4495,(%esp)
    1bfc:	e8 52 1d 00 00       	call   3953 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 95 44 00 00       	push   $0x4495
    1c0d:	e8 31 1d 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 00 1d 00 00       	call   392b <close>
    ...
    if(link("bd", name) != 0){
    1c51:	57                   	push   %edi
    1c52:	68 95 44 00 00       	push   $0x4495
    1c57:	e8 07 1d 00 00       	call   3963 <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 d6 1c 00 00       	call   3953 <unlink>
    ...
    if(unlink(name) != 0){
    1ca1:	57                   	push   %edi
    1ca2:	e8 ac 1c 00 00       	call   3953 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cc1:	6a 01                	push   $0x1
    1cc3:	e8 c8 1d 00 00       	call   3a90 <printf>
    ...
    1cdb:	6a 01                	push   $0x1
    1cdd:	e8 ae 1d 00 00       	call   3a90 <printf>
      exit();
    1ce2:	e8 1c 1c 00 00       	call   3903 <exit>
      printf(1, "bigdir unlink failed");
    1ce7:	83 ec 08             	sub    $0x8,%esp
    1cea:	68 c2 44 00 00       	push   $0x44c2
    1cef:	6a 01                	push   $0x1
    1cf1:	e8 9a 1d 00 00       	call   3a90 <printf>
      exit();
    1cf6:	e8 08 1c 00 00       	call   3903 <exit>
    printf(1, "bigdir create failed\n");
    1cfb:	50                   	push   %eax
    1cfc:	50                   	push   %eax
    1cfd:	68 98 44 00 00       	push   $0x4498
    1d02:	6a 01                	push   $0x1
    1d04:	e8 87 1d 00 00       	call   3a90 <printf>
    exit();
    1d09:	e8 f5 1b 00 00       	call   3903 <exit>
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 6d 1d 00 00       	call   3a90 <printf>
  unlink("ff");
    1d23:	c7 04 24 6b 45 00 00 	movl   $0x456b,(%esp)
    1d2a:	e8 24 1c 00 00       	call   3953 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d36:	e8 30 1c 00 00       	call   396b <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 eb 1b 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 ae 1b 00 00       	call   3923 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 ae 1b 00 00       	call   392b <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d84:	e8 ca 1b 00 00       	call   3953 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 ca 1b 00 00       	call   396b <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 85 1b 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 48 1b 00 00       	call   3923 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 48 1b 00 00       	call   392b <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 62 45 00 00       	push   $0x4562
    1dec:	e8 52 1b 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 0a 1b 00 00       	call   391b <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 f8 1a 00 00       	call   392b <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	59                   	pop    %ecx
    1e34:	5b                   	pop    %ebx
    1e35:	68 a2 45 00 00       	push   $0x45a2
    1e3a:	68 3e 45 00 00       	push   $0x453e
    1e3f:	e8 1f 1b 00 00       	call   3963 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 f7 1a 00 00       	call   3953 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 cd 1a 00 00       	call   3943 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 e5 1a 00 00       	call   3973 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 cd 1a 00 00       	call   3973 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 b5 1a 00 00       	call   3973 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 9d 1a 00 00       	call   3973 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 53 1a 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 0b 1a 00 00       	call   391b <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 06 1a 00 00       	call   392b <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	58                   	pop    %eax
    1f26:	5a                   	pop    %edx
    1f27:	6a 00                	push   $0x0
    1f29:	68 3e 45 00 00       	push   $0x453e
    1f2e:	e8 10 1a 00 00       	call   3943 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 f3 19 00 00       	call   3943 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 d6 19 00 00       	call   3943 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 b9 19 00 00       	call   3943 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 9f 19 00 00       	call   3943 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 85 19 00 00       	call   3943 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 88 19 00 00       	call   3963 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 6b 19 00 00       	call   3963 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 4e 19 00 00       	call   3963 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 3e 19 00 00       	call   396b <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 26 19 00 00       	call   396b <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 0e 19 00 00       	call   396b <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 de 18 00 00       	call   3953 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 c6 18 00 00       	call   3953 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 ce 18 00 00       	call   3973 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 b6 18 00 00       	call   3973 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 7e 18 00 00       	call   3953 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 66 18 00 00       	call   3953 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 4e 18 00 00       	call   3953 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 36 18 00 00       	call   3953 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 1e 18 00 00       	call   3953 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2148:	6a 01                	push   $0x1
    214a:	e8 41 19 00 00       	call   3a90 <printf>
}
    ...
    215e:	6a 01                	push   $0x1
    2160:	e8 2b 19 00 00       	call   3a90 <printf>
    exit();
    2165:	e8 99 17 00 00       	call   3903 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    216a:	50                   	push   %eax
    216b:	50                   	push   %eax
    216c:	68 e2 45 00 00       	push   $0x45e2
    2171:	6a 01                	push   $0x1
    2173:	e8 18 19 00 00       	call   3a90 <printf>
    exit();
    2178:	e8 86 17 00 00       	call   3903 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    217d:	50                   	push   %eax
    217e:	50                   	push   %eax
    217f:	68 ad 45 00 00       	push   $0x45ad
    2184:	6a 01                	push   $0x1
    2186:	e8 05 19 00 00       	call   3a90 <printf>
    exit();
    218b:	e8 73 17 00 00       	call   3903 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2190:	51                   	push   %ecx
    2191:	51                   	push   %ecx
    2192:	68 5f 46 00 00       	push   $0x465f
    2197:	6a 01                	push   $0x1
    2199:	e8 f2 18 00 00       	call   3a90 <printf>
    exit();
    219e:	e8 60 17 00 00       	call   3903 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21a3:	53                   	push   %ebx
    21a4:	53                   	push   %ebx
    21a5:	68 4c 50 00 00       	push   $0x504c
    21aa:	6a 01                	push   $0x1
    21ac:	e8 df 18 00 00       	call   3a90 <printf>
    exit();
    21b1:	e8 4d 17 00 00       	call   3903 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21b6:	51                   	push   %ecx
    21b7:	51                   	push   %ecx
    21b8:	68 f3 46 00 00       	push   $0x46f3
    21bd:	6a 01                	push   $0x1
    21bf:	e8 cc 18 00 00       	call   3a90 <printf>
    exit();
    21c4:	e8 3a 17 00 00       	call   3903 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21c9:	53                   	push   %ebx
    21ca:	53                   	push   %ebx
    21cb:	68 bc 50 00 00       	push   $0x50bc
    21d0:	6a 01                	push   $0x1
    21d2:	e8 b9 18 00 00       	call   3a90 <printf>
    exit();
    21d7:	e8 27 17 00 00       	call   3903 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21dc:	50                   	push   %eax
    21dd:	50                   	push   %eax
    21de:	68 6e 45 00 00       	push   $0x456e
    21e3:	6a 01                	push   $0x1
    21e5:	e8 a6 18 00 00       	call   3a90 <printf>
    exit();
    21ea:	e8 14 17 00 00       	call   3903 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ef:	51                   	push   %ecx
    21f0:	51                   	push   %ecx
    21f1:	68 47 45 00 00       	push   $0x4547
    21f6:	6a 01                	push   $0x1
    21f8:	e8 93 18 00 00       	call   3a90 <printf>
    exit();
    21fd:	e8 01 17 00 00       	call   3903 <exit>
    printf(1, "chdir ./.. failed\n");
    2202:	50                   	push   %eax
    2203:	50                   	push   %eax
    2204:	68 10 46 00 00       	push   $0x4610
    2209:	6a 01                	push   $0x1
    220b:	e8 80 18 00 00       	call   3a90 <printf>
    exit();
    2210:	e8 ee 16 00 00       	call   3903 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2215:	52                   	push   %edx
    2216:	52                   	push   %edx
    2217:	68 04 50 00 00       	push   $0x5004
    221c:	6a 01                	push   $0x1
    221e:	e8 6d 18 00 00       	call   3a90 <printf>
    exit();
    2223:	e8 db 16 00 00       	call   3903 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2228:	50                   	push   %eax
    2229:	50                   	push   %eax
    222a:	68 98 50 00 00       	push   $0x5098
    222f:	6a 01                	push   $0x1
    2231:	e8 5a 18 00 00       	call   3a90 <printf>
    exit();
    2236:	e8 c8 16 00 00       	call   3903 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 74 50 00 00       	push   $0x5074
    2242:	6a 01                	push   $0x1
    2244:	e8 47 18 00 00       	call   3a90 <printf>
    exit();
    2249:	e8 b5 16 00 00       	call   3903 <exit>
    printf(1, "open dd wronly succeeded!\n");
    224e:	50                   	push   %eax
    224f:	50                   	push   %eax
    2250:	68 cf 46 00 00       	push   $0x46cf
    2255:	6a 01                	push   $0x1
    2257:	e8 34 18 00 00       	call   3a90 <printf>
    exit();
    225c:	e8 a2 16 00 00       	call   3903 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2261:	50                   	push   %eax
    2262:	50                   	push   %eax
    2263:	68 b6 46 00 00       	push   $0x46b6
    2268:	6a 01                	push   $0x1
    226a:	e8 21 18 00 00       	call   3a90 <printf>
    exit();
    226f:	e8 8f 16 00 00       	call   3903 <exit>
    printf(1, "create dd succeeded!\n");
    2274:	50                   	push   %eax
    2275:	50                   	push   %eax
    2276:	68 a0 46 00 00       	push   $0x46a0
    227b:	6a 01                	push   $0x1
    227d:	e8 0e 18 00 00       	call   3a90 <printf>
    exit();
    2282:	e8 7c 16 00 00       	call   3903 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2287:	52                   	push   %edx
    2288:	52                   	push   %edx
    2289:	68 84 46 00 00       	push   $0x4684
    228e:	6a 01                	push   $0x1
    2290:	e8 fb 17 00 00       	call   3a90 <printf>
    exit();
    2295:	e8 69 16 00 00       	call   3903 <exit>
    printf(1, "chdir dd failed\n");
    229a:	50                   	push   %eax
    229b:	50                   	push   %eax
    229c:	68 c5 45 00 00       	push   $0x45c5
    22a1:	6a 01                	push   $0x1
    22a3:	e8 e8 17 00 00       	call   3a90 <printf>
    exit();
    22a8:	e8 56 16 00 00       	call   3903 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 28 50 00 00       	push   $0x5028
    22b4:	6a 01                	push   $0x1
    22b6:	e8 d5 17 00 00       	call   3a90 <printf>
    exit();
    22bb:	e8 43 16 00 00       	call   3903 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22c0:	53                   	push   %ebx
    22c1:	53                   	push   %ebx
    22c2:	68 23 45 00 00       	push   $0x4523
    22c7:	6a 01                	push   $0x1
    22c9:	e8 c2 17 00 00       	call   3a90 <printf>
    exit();
    22ce:	e8 30 16 00 00       	call   3903 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 dc 4f 00 00       	push   $0x4fdc
    22da:	6a 01                	push   $0x1
    22dc:	e8 af 17 00 00       	call   3a90 <printf>
    exit();
    22e1:	e8 1d 16 00 00       	call   3903 <exit>
    printf(1, "create dd/ff failed\n");
    22e6:	50                   	push   %eax
    22e7:	50                   	push   %eax
    22e8:	68 07 45 00 00       	push   $0x4507
    22ed:	6a 01                	push   $0x1
    22ef:	e8 9c 17 00 00       	call   3a90 <printf>
    exit();
    22f4:	e8 0a 16 00 00       	call   3903 <exit>
    printf(1, "subdir mkdir dd failed\n");
    22f9:	50                   	push   %eax
    22fa:	50                   	push   %eax
    22fb:	68 ef 44 00 00       	push   $0x44ef
    2300:	6a 01                	push   $0x1
    2302:	e8 89 17 00 00       	call   3a90 <printf>
    exit();
    2307:	e8 f7 15 00 00       	call   3903 <exit>
    printf(1, "unlink dd failed\n");
    230c:	50                   	push   %eax
    230d:	50                   	push   %eax
    230e:	68 d8 47 00 00       	push   $0x47d8
    2313:	6a 01                	push   $0x1
    2315:	e8 76 17 00 00       	call   3a90 <printf>
    exit();
    231a:	e8 e4 15 00 00       	call   3903 <exit>
    printf(1, "unlink dd/dd failed\n");
    231f:	52                   	push   %edx
    2320:	52                   	push   %edx
    2321:	68 c3 47 00 00       	push   $0x47c3
    2326:	6a 01                	push   $0x1
    2328:	e8 63 17 00 00       	call   3a90 <printf>
    exit();
    232d:	e8 d1 15 00 00       	call   3903 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 e0 50 00 00       	push   $0x50e0
    2339:	6a 01                	push   $0x1
    233b:	e8 50 17 00 00       	call   3a90 <printf>
    exit();
    2340:	e8 be 15 00 00       	call   3903 <exit>
    printf(1, "unlink dd/ff failed\n");
    2345:	53                   	push   %ebx
    2346:	53                   	push   %ebx
    2347:	68 ae 47 00 00       	push   $0x47ae
    234c:	6a 01                	push   $0x1
    234e:	e8 3d 17 00 00       	call   3a90 <printf>
    exit();
    2353:	e8 ab 15 00 00       	call   3903 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2358:	50                   	push   %eax
    2359:	50                   	push   %eax
    235a:	68 96 47 00 00       	push   $0x4796
    235f:	6a 01                	push   $0x1
    2361:	e8 2a 17 00 00       	call   3a90 <printf>
    exit();
    2366:	e8 98 15 00 00       	call   3903 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    236b:	50                   	push   %eax
    236c:	50                   	push   %eax
    236d:	68 7e 47 00 00       	push   $0x477e
    2372:	6a 01                	push   $0x1
    2374:	e8 17 17 00 00       	call   3a90 <printf>
    exit();
    2379:	e8 85 15 00 00       	call   3903 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    237e:	50                   	push   %eax
    237f:	50                   	push   %eax
    2380:	68 62 47 00 00       	push   $0x4762
    2385:	6a 01                	push   $0x1
    2387:	e8 04 17 00 00       	call   3a90 <printf>
    exit();
    238c:	e8 72 15 00 00       	call   3903 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2391:	50                   	push   %eax
    2392:	50                   	push   %eax
    2393:	68 46 47 00 00       	push   $0x4746
    2398:	6a 01                	push   $0x1
    239a:	e8 f1 16 00 00       	call   3a90 <printf>
    exit();
    239f:	e8 5f 15 00 00       	call   3903 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23a4:	50                   	push   %eax
    23a5:	50                   	push   %eax
    23a6:	68 29 47 00 00       	push   $0x4729
    23ab:	6a 01                	push   $0x1
    23ad:	e8 de 16 00 00       	call   3a90 <printf>
    exit();
    23b2:	e8 4c 15 00 00       	call   3903 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23b7:	52                   	push   %edx
    23b8:	52                   	push   %edx
    23b9:	68 0e 47 00 00       	push   $0x470e
    23be:	6a 01                	push   $0x1
    23c0:	e8 cb 16 00 00       	call   3a90 <printf>
    exit();
    23c5:	e8 39 15 00 00       	call   3903 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ca:	51                   	push   %ecx
    23cb:	51                   	push   %ecx
    23cc:	68 3b 46 00 00       	push   $0x463b
    23d1:	6a 01                	push   $0x1
    23d3:	e8 b8 16 00 00       	call   3a90 <printf>
    exit();
    23d8:	e8 26 15 00 00       	call   3903 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23dd:	53                   	push   %ebx
    23de:	53                   	push   %ebx
    23df:	68 23 46 00 00       	push   $0x4623
    23e4:	6a 01                	push   $0x1
    23e6:	e8 a5 16 00 00       	call   3a90 <printf>
    exit();
    23eb:	e8 13 15 00 00       	call   3903 <exit>
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2402:	6a 01                	push   $0x1
    2404:	e8 87 16 00 00       	call   3a90 <printf>
  unlink("bigwrite");
    2409:	c7 04 24 04 48 00 00 	movl   $0x4804,(%esp)
    2410:	e8 3e 15 00 00       	call   3953 <unlink>
    ...
    242d:	e8 11 15 00 00       	call   3943 <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 d9 14 00 00       	call   3923 <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 c3 14 00 00       	call   3923 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 b5 14 00 00       	call   392b <close>
    unlink("bigwrite");
    2476:	c7 04 24 04 48 00 00 	movl   $0x4804,(%esp)
    247d:	e8 d1 14 00 00       	call   3953 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2495:	6a 01                	push   $0x1
    2497:	e8 f4 15 00 00       	call   3a90 <printf>
}
    ...
    24ad:	6a 01                	push   $0x1
    24af:	e8 dc 15 00 00       	call   3a90 <printf>
        exit();
    24b4:	e8 4a 14 00 00       	call   3903 <exit>
      printf(1, "cannot create bigwrite\n");
    24b9:	83 ec 08             	sub    $0x8,%esp
    24bc:	68 0d 48 00 00       	push   $0x480d
    24c1:	6a 01                	push   $0x1
    24c3:	e8 c8 15 00 00       	call   3a90 <printf>
      exit();
    24c8:	e8 36 14 00 00       	call   3903 <exit>
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2538:	56                   	push   %esi
    2539:	e8 e5 13 00 00       	call   3923 <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 ce 13 00 00       	call   392b <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 60 48 00 00       	push   $0x4860
    2566:	e8 d8 13 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 5a 13 00 00       	call   391b <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 58 13 00 00       	call   392b <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 64 13 00 00       	call   3953 <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 ef 48 00 00       	push   $0x48ef
    25f6:	6a 01                	push   $0x1
    25f8:	e8 93 14 00 00       	call   3a90 <printf>
}
    ...
    2610:	6a 01                	push   $0x1
    2612:	e8 79 14 00 00       	call   3a90 <printf>
      exit();
    2617:	e8 e7 12 00 00       	call   3903 <exit>
      printf(1, "short read bigfile\n");
    261c:	83 ec 08             	sub    $0x8,%esp
    261f:	68 a8 48 00 00       	push   $0x48a8
    2624:	6a 01                	push   $0x1
    2626:	e8 65 14 00 00       	call   3a90 <printf>
      exit();
    262b:	e8 d3 12 00 00       	call   3903 <exit>
      printf(1, "read bigfile failed\n");
    2630:	83 ec 08             	sub    $0x8,%esp
    2633:	68 93 48 00 00       	push   $0x4893
    2638:	6a 01                	push   $0x1
    263a:	e8 51 14 00 00       	call   3a90 <printf>
      exit();
    263f:	e8 bf 12 00 00       	call   3903 <exit>
      printf(1, "write bigfile failed\n");
    2644:	83 ec 08             	sub    $0x8,%esp
    2647:	68 68 48 00 00       	push   $0x4868
    264c:	6a 01                	push   $0x1
    264e:	e8 3d 14 00 00       	call   3a90 <printf>
      exit();
    2653:	e8 ab 12 00 00       	call   3903 <exit>
    printf(1, "cannot open bigfile\n");
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 7e 48 00 00       	push   $0x487e
    265f:	6a 01                	push   $0x1
    2661:	e8 2a 14 00 00       	call   3a90 <printf>
    exit();
    2666:	e8 98 12 00 00       	call   3903 <exit>
    printf(1, "cannot create bigfile");
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 52 48 00 00       	push   $0x4852
    2672:	6a 01                	push   $0x1
    2674:	e8 17 14 00 00       	call   3a90 <printf>
    exit();
    2679:	e8 85 12 00 00       	call   3903 <exit>
    printf(1, "read bigfile wrong total\n");
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 d5 48 00 00       	push   $0x48d5
    2685:	6a 01                	push   $0x1
    2687:	e8 04 14 00 00       	call   3a90 <printf>
    exit();
    268c:	e8 72 12 00 00       	call   3903 <exit>
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26ab:	6a 01                	push   $0x1
    26ad:	e8 de 13 00 00       	call   3a90 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 3b 49 00 00 	movl   $0x493b,(%esp)
    26b9:	e8 ad 12 00 00       	call   396b <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 00 51 00 00       	push   $0x5100
    26d1:	e8 95 12 00 00       	call   396b <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 50 51 00 00       	push   $0x5150
    26ee:	e8 50 12 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 24 12 00 00       	call   392b <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 c0 51 00 00       	push   $0x51c0
    2710:	e8 2e 12 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  printf(1, "fourteen ok\n");
    ...
    2754:	6a 01                	push   $0x1
    2756:	e8 35 13 00 00       	call   3a90 <printf>
}
    ...
    2767:	6a 01                	push   $0x1
    2769:	e8 22 13 00 00       	call   3a90 <printf>
    exit();
    276e:	e8 90 11 00 00       	call   3903 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 7c 52 00 00       	push   $0x527c
    277a:	6a 01                	push   $0x1
    277c:	e8 0f 13 00 00       	call   3a90 <printf>
    exit();
    2781:	e8 7d 11 00 00       	call   3903 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 2c 52 00 00       	push   $0x522c
    278d:	6a 01                	push   $0x1
    278f:	e8 fc 12 00 00       	call   3a90 <printf>
    exit();
    2794:	e8 6a 11 00 00       	call   3903 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 f0 51 00 00       	push   $0x51f0
    27a0:	6a 01                	push   $0x1
    27a2:	e8 e9 12 00 00       	call   3a90 <printf>
    exit();
    27a7:	e8 57 11 00 00       	call   3903 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 80 51 00 00       	push   $0x5180
    27b3:	6a 01                	push   $0x1
    27b5:	e8 d6 12 00 00       	call   3a90 <printf>
    exit();
    27ba:	e8 44 11 00 00       	call   3903 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 20 51 00 00       	push   $0x5120
    27c6:	6a 01                	push   $0x1
    27c8:	e8 c3 12 00 00       	call   3a90 <printf>
    exit();
    27cd:	e8 31 11 00 00       	call   3903 <exit>
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    ...
    27eb:	6a 01                	push   $0x1
    27ed:	e8 9e 12 00 00       	call   3a90 <printf>
  if(mkdir("dots") != 0){
    27f2:	c7 04 24 63 49 00 00 	movl   $0x4963,(%esp)
    27f9:	e8 6d 11 00 00       	call   396b <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 5d 11 00 00       	call   3973 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 25 11 00 00       	call   3953 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 0d 11 00 00       	call   3953 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 15 11 00 00       	call   3973 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 dd 10 00 00       	call   3953 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 c9 10 00 00       	call   3953 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 b5 10 00 00       	call   3953 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    28ad:	6a 01                	push   $0x1
    28af:	e8 dc 11 00 00       	call   3a90 <printf>
}
    ...
    28c0:	6a 01                	push   $0x1
    28c2:	e8 c9 11 00 00       	call   3a90 <printf>
    exit();
    28c7:	e8 37 10 00 00       	call   3903 <exit>
    printf(1, "unlink dots failed!\n");
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 e9 49 00 00       	push   $0x49e9
    28d3:	6a 01                	push   $0x1
    28d5:	e8 b6 11 00 00       	call   3a90 <printf>
    exit();
    28da:	e8 24 10 00 00       	call   3903 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 d1 49 00 00       	push   $0x49d1
    28e6:	6a 01                	push   $0x1
    28e8:	e8 a3 11 00 00       	call   3a90 <printf>
    exit();
    28ed:	e8 11 10 00 00       	call   3903 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 b2 49 00 00       	push   $0x49b2
    28f9:	6a 01                	push   $0x1
    28fb:	e8 90 11 00 00       	call   3a90 <printf>
    exit();
    2900:	e8 fe 0f 00 00       	call   3903 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 e3 3d 00 00       	push   $0x3de3
    290c:	6a 01                	push   $0x1
    290e:	e8 7d 11 00 00       	call   3a90 <printf>
    exit();
    2913:	e8 eb 0f 00 00       	call   3903 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 9c 49 00 00       	push   $0x499c
    291f:	6a 01                	push   $0x1
    2921:	e8 6a 11 00 00       	call   3a90 <printf>
    exit();
    2926:	e8 d8 0f 00 00       	call   3903 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 8e 49 00 00       	push   $0x498e
    2932:	6a 01                	push   $0x1
    2934:	e8 57 11 00 00       	call   3a90 <printf>
    exit();
    2939:	e8 c5 0f 00 00       	call   3903 <exit>
    printf(1, "chdir dots failed\n");
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 7b 49 00 00       	push   $0x497b
    2945:	6a 01                	push   $0x1
    2947:	e8 44 11 00 00       	call   3a90 <printf>
    exit();
    294c:	e8 b2 0f 00 00       	call   3903 <exit>
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    296c:	6a 01                	push   $0x1
    296e:	e8 1d 11 00 00       	call   3a90 <printf>
  fd = open("dirfile", O_CREATE);
    2973:	5b                   	pop    %ebx
    2974:	58                   	pop    %eax
    2975:	68 00 02 00 00       	push   $0x200
    297a:	68 15 4a 00 00       	push   $0x4a15
    297f:	e8 bf 0f 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 93 0f 00 00       	call   392b <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 15 4a 00 00 	movl   $0x4a15,(%esp)
    299f:	e8 cf 0f 00 00       	call   3973 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 85 0f 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 68 0f 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 78 0f 00 00       	call   396b <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 48 0f 00 00       	call   3953 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 3b 0f 00 00       	call   3963 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 13 0f 00 00       	call   3953 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 e9 0e 00 00       	call   3943 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 cf 0e 00 00       	call   3943 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 9d 0e 00 00       	call   3923 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 95 0e 00 00       	call   392b <close>
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 e5 4a 00 00       	push   $0x4ae5
    2a9d:	6a 01                	push   $0x1
    2a9f:	e8 ec 0f 00 00       	call   3a90 <printf>
}
    ...
    2ab3:	6a 01                	push   $0x1
    2ab5:	e8 d6 0f 00 00       	call   3a90 <printf>
    exit();
    2aba:	e8 44 0e 00 00       	call   3903 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2abf:	52                   	push   %edx
    2ac0:	52                   	push   %edx
    2ac1:	68 34 4a 00 00       	push   $0x4a34
    2ac6:	6a 01                	push   $0x1
    2ac8:	e8 c3 0f 00 00       	call   3a90 <printf>
    exit();
    2acd:	e8 31 0e 00 00       	call   3903 <exit>
    printf(1, "create dirfile failed\n");
    2ad2:	51                   	push   %ecx
    2ad3:	51                   	push   %ecx
    2ad4:	68 1d 4a 00 00       	push   $0x4a1d
    2ad9:	6a 01                	push   $0x1
    2adb:	e8 b0 0f 00 00       	call   3a90 <printf>
    exit();
    2ae0:	e8 1e 0e 00 00       	call   3903 <exit>
    printf(1, "write . succeeded!\n");
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 d1 4a 00 00       	push   $0x4ad1
    2aec:	6a 01                	push   $0x1
    2aee:	e8 9d 0f 00 00       	call   3a90 <printf>
    exit();
    2af3:	e8 0b 0e 00 00       	call   3903 <exit>
    printf(1, "open . for writing succeeded!\n");
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 d0 52 00 00       	push   $0x52d0
    2aff:	6a 01                	push   $0x1
    2b01:	e8 8a 0f 00 00       	call   3a90 <printf>
    exit();
    2b06:	e8 f8 0d 00 00       	call   3903 <exit>
    printf(1, "unlink dirfile failed!\n");
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 b9 4a 00 00       	push   $0x4ab9
    2b12:	6a 01                	push   $0x1
    2b14:	e8 77 0f 00 00       	call   3a90 <printf>
    exit();
    2b19:	e8 e5 0d 00 00       	call   3903 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 b0 52 00 00       	push   $0x52b0
    2b25:	6a 01                	push   $0x1
    2b27:	e8 64 0f 00 00       	call   3a90 <printf>
    exit();
    2b2c:	e8 d2 0d 00 00       	call   3903 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 94 4a 00 00       	push   $0x4a94
    2b38:	6a 01                	push   $0x1
    2b3a:	e8 51 0f 00 00       	call   3a90 <printf>
    exit();
    2b3f:	e8 bf 0d 00 00       	call   3903 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 77 4a 00 00       	push   $0x4a77
    2b4b:	6a 01                	push   $0x1
    2b4d:	e8 3e 0f 00 00       	call   3a90 <printf>
    exit();
    2b52:	e8 ac 0d 00 00       	call   3903 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b71:	6a 01                	push   $0x1
    2b73:	e8 18 0f 00 00       	call   3a90 <printf>
    ...
    2b88:	e8 de 0d 00 00       	call   396b <mkdir>
    ...
    2ba0:	e8 ce 0d 00 00       	call   3973 <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 36 0d 00 00       	call   3973 <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 34 4b 00 00       	push   $0x4b34
    2c44:	6a 01                	push   $0x1
    2c46:	e8 45 0e 00 00       	call   3a90 <printf>
}
    ...
    2c5b:	6a 01                	push   $0x1
    2c5d:	e8 2e 0e 00 00       	call   3a90 <printf>
      exit();
    2c62:	e8 9c 0c 00 00       	call   3903 <exit>
      printf(1, "chdir irefd failed\n");
    2c67:	83 ec 08             	sub    $0x8,%esp
    2c6a:	68 20 4b 00 00       	push   $0x4b20
    2c6f:	6a 01                	push   $0x1
    2c71:	e8 1a 0e 00 00       	call   3a90 <printf>
      exit();
    2c76:	e8 88 0c 00 00       	call   3903 <exit>
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c8e:	6a 01                	push   $0x1
    2c90:	e8 fb 0d 00 00       	call   3a90 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 49 0c 00 00       	call   38fb <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 46 0c 00 00       	call   390b <wait>
  ...
  if(wait() != -1){
    2cce:	e8 38 0c 00 00       	call   390b <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2ce0:	6a 01                	push   $0x1
    2ce2:	e8 a9 0d 00 00       	call   3a90 <printf>
}
    2ce7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cea:	c9                   	leave
    2ceb:	c3                   	ret
      exit();
    2cec:	e8 12 0c 00 00       	call   3903 <exit>
      printf(1, "wait stopped early\n");
    2cf1:	83 ec 08             	sub    $0x8,%esp
    2cf4:	68 53 4b 00 00       	push   $0x4b53
    2cf9:	6a 01                	push   $0x1
    2cfb:	e8 90 0d 00 00       	call   3a90 <printf>
      exit();
    2d00:	e8 fe 0b 00 00       	call   3903 <exit>
    printf(1, "wait got too many\n");
    2d05:	52                   	push   %edx
    2d06:	52                   	push   %edx
    2d07:	68 67 4b 00 00       	push   $0x4b67
    2d0c:	6a 01                	push   $0x1
    2d0e:	e8 7d 0d 00 00       	call   3a90 <printf>
    exit();
    2d13:	e8 eb 0b 00 00       	call   3903 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 f0 52 00 00       	push   $0x52f0
    2d1f:	6a 01                	push   $0x1
    2d21:	e8 6a 0d 00 00       	call   3a90 <printf>
    exit();
    2d26:	e8 d8 0b 00 00       	call   3903 <exit>
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 98 5e 00 00    	push   0x5e98
    2d46:	e8 45 0d 00 00       	call   3a90 <printf>
  oldbrk = sbrk(0);
    2d4b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d52:	e8 34 0c 00 00       	call   398b <sbrk>
    2d57:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d5a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d61:	e8 25 0c 00 00       	call   398b <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 0f 0c 00 00       	call   398b <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 5e 0b 00 00       	call   38fb <fork>
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 d7 0b 00 00       	call   398b <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 cb 0b 00 00       	call   398b <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 33 0b 00 00       	call   390b <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 a9 0b 00 00       	call   398b <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 98 0b 00 00       	call   398b <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 7c 0b 00 00       	call   398b <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e18:	e8 6e 0b 00 00       	call   398b <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 58 0b 00 00       	call   398b <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 3d 0b 00 00       	call   398b <sbrk>
  c = sbrk(4096);
    2e4e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e55:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e57:	e8 2f 0b 00 00       	call   398b <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 18 0b 00 00       	call   398b <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ecf:	00 
    ppid = getpid();
    2ed0:	e8 ae 0a 00 00       	call   3983 <getpid>
    2ed5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ed7:	e8 1f 0a 00 00       	call   38fb <fork>
    if(pid < 0){
    ...
    wait();
    2eea:	e8 1c 0a 00 00       	call   390b <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f03:	50                   	push   %eax
    2f04:	e8 0a 0a 00 00       	call   3913 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f20:	e8 d6 09 00 00       	call   38fb <fork>
    ...
    2f40:	e8 d6 09 00 00       	call   391b <read>
  ...
  c = sbrk(4096);
    ...
    2f57:	e8 2f 0a 00 00       	call   398b <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f72:	50                   	push   %eax
    2f73:	e8 bb 09 00 00       	call   3933 <kill>
    wait();
    2f78:	e8 8e 09 00 00       	call   390b <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f93:	6a 00                	push   $0x0
    2f95:	e8 f1 09 00 00       	call   398b <sbrk>
    2f9a:	83 c4 10             	add    $0x10,%esp
    2f9d:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa0:	72 60                	jb     3002 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2fa2:	83 ec 08             	sub    $0x8,%esp
    2fa5:	68 30 4c 00 00       	push   $0x4c30
    2faa:	ff 35 98 5e 00 00    	push   0x5e98
    2fb0:	e8 db 0a 00 00       	call   3a90 <printf>
}
    ...
    3027:	53                   	push   %ebx
    3028:	56                   	push   %esi
    3029:	68 93 4b 00 00       	push   $0x4b93
    302e:	ff 35 98 5e 00 00    	push   0x5e98
    3034:	e8 57 0a 00 00       	call   3a90 <printf>
      exit();
    3039:	83 c4 20             	add    $0x20,%esp
    303c:	e8 c2 08 00 00       	call   3903 <exit>
      printf(stdout, "fork failed\n");
    3041:	83 ec 08             	sub    $0x8,%esp
    3044:	68 d9 4c 00 00       	push   $0x4cd9
    3049:	ff 35 98 5e 00 00    	push   0x5e98
    304f:	e8 3c 0a 00 00       	call   3a90 <printf>
      exit();
    3054:	e8 aa 08 00 00       	call   3903 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3059:	0f be 03             	movsbl (%ebx),%eax
    305c:	50                   	push   %eax
    305d:	53                   	push   %ebx
    305e:	68 fc 4b 00 00       	push   $0x4bfc
    3063:	ff 35 98 5e 00 00    	push   0x5e98
    3069:	e8 22 0a 00 00       	call   3a90 <printf>
      kill(ppid);
    306e:	89 34 24             	mov    %esi,(%esp)
    3071:	e8 bd 08 00 00       	call   3933 <kill>
      exit();
    3076:	e8 88 08 00 00       	call   3903 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    307b:	50                   	push   %eax
    307c:	53                   	push   %ebx
    307d:	68 e4 53 00 00       	push   $0x53e4
    3082:	ff 35 98 5e 00 00    	push   0x5e98
    3088:	e8 03 0a 00 00       	call   3a90 <printf>
    exit();
    308d:	e8 71 08 00 00       	call   3903 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    3092:	56                   	push   %esi
    3093:	56                   	push   %esi
    3094:	68 14 53 00 00       	push   $0x5314
    3099:	ff 35 98 5e 00 00    	push   0x5e98
    309f:	e8 ec 09 00 00       	call   3a90 <printf>
    exit();
    30a4:	e8 5a 08 00 00       	call   3903 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30a9:	50                   	push   %eax
    30aa:	50                   	push   %eax
    30ab:	68 ae 4b 00 00       	push   $0x4bae
    30b0:	ff 35 98 5e 00 00    	push   0x5e98
    30b6:	e8 d5 09 00 00       	call   3a90 <printf>
    exit();
    30bb:	e8 43 08 00 00       	call   3903 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30c0:	51                   	push   %ecx
    30c1:	51                   	push   %ecx
    30c2:	68 b4 53 00 00       	push   $0x53b4
    30c7:	ff 35 98 5e 00 00    	push   0x5e98
    30cd:	e8 be 09 00 00       	call   3a90 <printf>
    exit();
    30d2:	e8 2c 08 00 00       	call   3903 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30d7:	50                   	push   %eax
    30d8:	50                   	push   %eax
    30d9:	68 15 4c 00 00       	push   $0x4c15
    30de:	ff 35 98 5e 00 00    	push   0x5e98
    30e4:	e8 a7 09 00 00       	call   3a90 <printf>
    exit();
    30e9:	e8 15 08 00 00       	call   3903 <exit>
    printf(1, "pipe() failed\n");
    30ee:	52                   	push   %edx
    30ef:	52                   	push   %edx
    30f0:	68 d1 40 00 00       	push   $0x40d1
    30f5:	6a 01                	push   $0x1
    30f7:	e8 94 09 00 00       	call   3a90 <printf>
    exit();
    30fc:	e8 02 08 00 00       	call   3903 <exit>
    exit();
    3101:	e8 fd 07 00 00       	call   3903 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3106:	57                   	push   %edi
    3107:	57                   	push   %edi
    3108:	68 c5 4b 00 00       	push   $0x4bc5
    310d:	ff 35 98 5e 00 00    	push   0x5e98
    3113:	e8 78 09 00 00       	call   3a90 <printf>
    exit();
    3118:	e8 e6 07 00 00       	call   3903 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    311d:	56                   	push   %esi
    311e:	53                   	push   %ebx
    311f:	68 8c 53 00 00       	push   $0x538c
    3124:	ff 35 98 5e 00 00    	push   0x5e98
    312a:	e8 61 09 00 00       	call   3a90 <printf>
    exit();
    312f:	e8 cf 07 00 00       	call   3903 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3134:	50                   	push   %eax
    3135:	53                   	push   %ebx
    3136:	68 54 53 00 00       	push   $0x5354
    313b:	ff 35 98 5e 00 00    	push   0x5e98
    3141:	e8 4a 09 00 00       	call   3a90 <printf>
    exit();
    3146:	e8 b8 07 00 00       	call   3903 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    314b:	53                   	push   %ebx
    314c:	53                   	push   %ebx
    314d:	68 e1 4b 00 00       	push   $0x4be1
    3152:	ff 35 98 5e 00 00    	push   0x5e98
    3158:	e8 33 09 00 00       	call   3a90 <printf>
    exit();
    315d:	e8 a1 07 00 00       	call   3903 <exit>
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318f:	ff 35 98 5e 00 00    	push   0x5e98
    3195:	e8 f6 08 00 00       	call   3a90 <printf>
    319a:	83 c4 10             	add    $0x10,%esp
    319d:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31a0:	e8 56 07 00 00       	call   38fb <fork>
    ...
    31ae:	6a 00                	push   $0x0
    31b0:	e8 de 07 00 00       	call   3993 <sleep>
    sleep(0);
    31b5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31bc:	e8 d2 07 00 00       	call   3993 <sleep>
    kill(pid);
    31c1:	89 1c 24             	mov    %ebx,(%esp)
    31c4:	e8 6a 07 00 00       	call   3933 <kill>
    wait();
    31c9:	e8 3d 07 00 00       	call   390b <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31ce:	58                   	pop    %eax
    31cf:	5a                   	pop    %edx
    31d0:	56                   	push   %esi
    31d1:	68 4d 4c 00 00       	push   $0x4c4d
    31d6:	e8 88 07 00 00       	call   3963 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31f9:	ff 35 98 5e 00 00    	push   0x5e98
    31ff:	e8 8c 08 00 00       	call   3a90 <printf>
}
    ...
    320d:	c3                   	ret
      exit();
    320e:	e8 f0 06 00 00       	call   3903 <exit>
      printf(stdout, "link should not succeed\n");
    3213:	83 ec 08             	sub    $0x8,%esp
    3216:	68 58 4c 00 00       	push   $0x4c58
    321b:	ff 35 98 5e 00 00    	push   0x5e98
    3221:	e8 6a 08 00 00       	call   3a90 <printf>
      exit();
    3226:	e8 d8 06 00 00       	call   3903 <exit>
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    323b:	ff 35 98 5e 00 00    	push   0x5e98
    3241:	e8 4a 08 00 00       	call   3a90 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    326b:	ff 35 98 5e 00 00    	push   0x5e98
    3271:	e8 1a 08 00 00       	call   3a90 <printf>
}
    ...
    3283:	ff 35 98 5e 00 00    	push   0x5e98
    3289:	e8 02 08 00 00       	call   3a90 <printf>
      exit();
    328e:	e8 70 06 00 00       	call   3903 <exit>
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32ab:	e8 a3 06 00 00       	call   3953 <unlink>
  pid = fork();
    32b0:	e8 46 06 00 00       	call   38fb <fork>
  if(pid == 0){
  ...
  wait();
    32c2:	e8 44 06 00 00       	call   390b <wait>
  fd = open("bigarg-ok", 0);
    32c7:	83 ec 08             	sub    $0x8,%esp
    32ca:	6a 00                	push   $0x0
    32cc:	68 a6 4c 00 00       	push   $0x4ca6
    32d1:	e8 6d 06 00 00       	call   3943 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32e4:	50                   	push   %eax
    32e5:	e8 41 06 00 00       	call   392b <close>
  unlink("bigarg-ok");
    32ea:	c7 04 24 a6 4c 00 00 	movl   $0x4ca6,(%esp)
    32f1:	e8 5d 06 00 00       	call   3953 <unlink>
}
    32f6:	83 c4 10             	add    $0x10,%esp
    32f9:	c9                   	leave
    32fa:	c3                   	ret
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32fb:	c7 04 85 e0 a5 00 00 	movl   $0x5408,0xa5e0(,%eax,4)
    3302:	08 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 e0 a5 00 00 	movl   $0x5408,0xa5e0(,%eax,4)
    3312:	08 54 00 00 
    3316:	c7 04 85 e4 a5 00 00 	movl   $0x5408,0xa5e4(,%eax,4)
    331d:	08 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    printf(stdout, "bigarg test\n");
    332c:	50                   	push   %eax
    332d:	68 b0 4c 00 00       	push   $0x4cb0
    3332:	ff 35 98 5e 00 00    	push   0x5e98
    args[MAXARG-1] = 0;
    3338:	89 0d 5c a6 00 00    	mov    %ecx,0xa65c
    printf(stdout, "bigarg test\n");
    333e:	e8 4d 07 00 00       	call   3a90 <printf>
    exec("echo", args);
    3343:	58                   	pop    %eax
    3344:	5a                   	pop    %edx
    3345:	68 e0 a5 00 00       	push   $0xa5e0
    334a:	68 7d 3e 00 00       	push   $0x3e7d
    334f:	e8 e7 05 00 00       	call   393b <exec>
    printf(stdout, "bigarg test ok\n");
    3354:	59                   	pop    %ecx
    3355:	58                   	pop    %eax
    3356:	68 bd 4c 00 00       	push   $0x4cbd
    335b:	ff 35 98 5e 00 00    	push   0x5e98
    3361:	e8 2a 07 00 00       	call   3a90 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3366:	58                   	pop    %eax
    3367:	5a                   	pop    %edx
    3368:	68 00 02 00 00       	push   $0x200
    336d:	68 a6 4c 00 00       	push   $0x4ca6
    3372:	e8 cc 05 00 00       	call   3943 <open>
    close(fd);
    3377:	89 04 24             	mov    %eax,(%esp)
    337a:	e8 ac 05 00 00       	call   392b <close>
    exit();
    337f:	e8 7f 05 00 00       	call   3903 <exit>
    printf(stdout, "bigarg test failed!\n");
    3384:	50                   	push   %eax
    3385:	50                   	push   %eax
    3386:	68 e6 4c 00 00       	push   $0x4ce6
    338b:	ff 35 98 5e 00 00    	push   0x5e98
    3391:	e8 fa 06 00 00       	call   3a90 <printf>
    exit();
    3396:	e8 68 05 00 00       	call   3903 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    339b:	52                   	push   %edx
    339c:	52                   	push   %edx
    339d:	68 cd 4c 00 00       	push   $0x4ccd
    33a2:	ff 35 98 5e 00 00    	push   0x5e98
    33a8:	e8 e3 06 00 00       	call   3a90 <printf>
    exit();
    33ad:	e8 51 05 00 00       	call   3903 <exit>
    ...
    33c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33cb:	68 fb 4c 00 00       	push   $0x4cfb
    33d0:	6a 01                	push   $0x1
    33d2:	e8 b9 06 00 00       	call   3a90 <printf>
    ...
    3451:	50                   	push   %eax
    3452:	68 08 4d 00 00       	push   $0x4d08
    3457:	6a 01                	push   $0x1
    3459:	e8 32 06 00 00       	call   3a90 <printf>
    ...
    3468:	50                   	push   %eax
    3469:	e8 d5 04 00 00       	call   3943 <open>
    if(fd < 0){
    ...
    348f:	57                   	push   %edi
    3490:	e8 8e 04 00 00       	call   3923 <write>
      if(cc < 512)
    ...
    34a2:	53                   	push   %ebx
    34a3:	68 24 4d 00 00       	push   $0x4d24
    34a8:	6a 01                	push   $0x1
    34aa:	e8 e1 05 00 00       	call   3a90 <printf>
    close(fd);
    34af:	89 3c 24             	mov    %edi,(%esp)
    34b2:	e8 74 04 00 00       	call   392b <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34cc:	50                   	push   %eax
    34cd:	68 14 4d 00 00       	push   $0x4d14
    34d2:	6a 01                	push   $0x1
    34d4:	e8 b7 05 00 00       	call   3a90 <printf>
      break;
    ...
    355b:	50                   	push   %eax
    355c:	e8 f2 03 00 00       	call   3953 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    356c:	68 34 4d 00 00       	push   $0x4d34
    3571:	6a 01                	push   $0x1
    3573:	e8 18 05 00 00       	call   3a90 <printf>
}
...
00003590 <uio>:
{
  ...
  printf(1, "uio test\n");
    3596:	68 4a 4d 00 00       	push   $0x4d4a
    359b:	6a 01                	push   $0x1
    359d:	e8 ee 04 00 00       	call   3a90 <printf>
  pid = fork();
    35a2:	e8 54 03 00 00       	call   38fb <fork>
  if(pid == 0){
  ...
  wait();
    35b0:	e8 56 03 00 00       	call   390b <wait>
  printf(1, "uio test done\n");
    35b5:	83 ec 08             	sub    $0x8,%esp
    35b8:	68 54 4d 00 00       	push   $0x4d54
    35bd:	6a 01                	push   $0x1
    35bf:	e8 cc 04 00 00       	call   3a90 <printf>
}
    ...
    35da:	52                   	push   %edx
    35db:	52                   	push   %edx
    35dc:	68 e8 54 00 00       	push   $0x54e8
    35e1:	6a 01                	push   $0x1
    35e3:	e8 a8 04 00 00       	call   3a90 <printf>
    exit();
    35e8:	e8 16 03 00 00       	call   3903 <exit>
    printf (1, "fork failed\n");
    35ed:	50                   	push   %eax
    35ee:	50                   	push   %eax
    35ef:	68 d9 4c 00 00       	push   $0x4cd9
    35f4:	6a 01                	push   $0x1
    35f6:	e8 95 04 00 00       	call   3a90 <printf>
    exit();
    35fb:	e8 03 03 00 00       	call   3903 <exit>
...
00003600 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3607:	6a 00                	push   $0x0
    3609:	68 63 4d 00 00       	push   $0x4d63
    360e:	e8 30 03 00 00       	call   3943 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    361f:	6a 00                	push   $0x0
    3621:	e8 65 03 00 00       	call   398b <sbrk>
    3626:	83 c4 0c             	add    $0xc,%esp
    3629:	83 e8 01             	sub    $0x1,%eax
    362c:	6a ff                	push   $0xffffffff
    362e:	50                   	push   %eax
    362f:	53                   	push   %ebx
    3630:	e8 e6 02 00 00       	call   391b <read>
  close(fd);
    3635:	89 1c 24             	mov    %ebx,(%esp)
    3638:	e8 ee 02 00 00       	call   392b <close>
  printf(1, "arg test passed\n");
    363d:	58                   	pop    %eax
    363e:	5a                   	pop    %edx
    363f:	68 75 4d 00 00       	push   $0x4d75
    3644:	6a 01                	push   $0x1
    3646:	e8 45 04 00 00       	call   3a90 <printf>
}
    ...
    3653:	51                   	push   %ecx
    3654:	51                   	push   %ecx
    3655:	68 68 4d 00 00       	push   $0x4d68
    365a:	6a 02                	push   $0x2
    365c:	e8 2f 04 00 00       	call   3a90 <printf>
    exit();
    3661:	e8 9d 02 00 00       	call   3903 <exit>
...
00003670 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3670:	69 05 94 5e 00 00 0d 	imul   $0x19660d,0x5e94,%eax
    3677:	66 19 00 
    367a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    367f:	a3 94 5e 00 00       	mov    %eax,0x5e94
}
    3684:	c3                   	ret
    ...
    37b9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37c5:	56                   	push   %esi
    37c6:	6a 00                	push   $0x0
    37c8:	e8 4e 01 00 00       	call   391b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 21 01 00 00       	call   3943 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 24 01 00 00       	call   395b <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 ea 00 00 00       	call   392b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
  ...
  void* uva_stack = malloc(4096);
    ...
    38db:	e8 d0 03 00 00       	call   3cb0 <malloc>

  if ((thread_id = clone(fn, arg, uva_stack)) < 0)
    38e0:	83 c4 0c             	add    $0xc,%esp
    38e3:	50                   	push   %eax
    38e4:	ff 75 0c             	push   0xc(%ebp)
    38e7:	ff 75 08             	push   0x8(%ebp)
    38ea:	e8 b4 00 00 00       	call   39a3 <clone>
    38ef:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
}
    38f4:	c9                   	leave
...
00003903 <exit>:
SYSCALL(exit)
    3903:	b8 02 00 00 00       	mov    $0x2,%eax
    3908:	cd 40                	int    $0x40
    390a:	c3                   	ret

0000390b <wait>:
SYSCALL(wait)
    390b:	b8 03 00 00 00       	mov    $0x3,%eax
    3910:	cd 40                	int    $0x40
    3912:	c3                   	ret

00003913 <pipe>:
SYSCALL(pipe)
    3913:	b8 04 00 00 00       	mov    $0x4,%eax
    3918:	cd 40                	int    $0x40
    391a:	c3                   	ret

0000391b <read>:
SYSCALL(read)
    391b:	b8 05 00 00 00       	mov    $0x5,%eax
    3920:	cd 40                	int    $0x40
    3922:	c3                   	ret

00003923 <write>:
SYSCALL(write)
    3923:	b8 10 00 00 00       	mov    $0x10,%eax
    3928:	cd 40                	int    $0x40
    392a:	c3                   	ret

0000392b <close>:
SYSCALL(close)
    392b:	b8 15 00 00 00       	mov    $0x15,%eax
    3930:	cd 40                	int    $0x40
    3932:	c3                   	ret

00003933 <kill>:
SYSCALL(kill)
    3933:	b8 06 00 00 00       	mov    $0x6,%eax
    3938:	cd 40                	int    $0x40
    393a:	c3                   	ret

0000393b <exec>:
SYSCALL(exec)
    393b:	b8 07 00 00 00       	mov    $0x7,%eax
    3940:	cd 40                	int    $0x40
    3942:	c3                   	ret

00003943 <open>:
SYSCALL(open)
    3943:	b8 0f 00 00 00       	mov    $0xf,%eax
    3948:	cd 40                	int    $0x40
    394a:	c3                   	ret
...
0000395b <fstat>:
SYSCALL(fstat)
    395b:	b8 08 00 00 00       	mov    $0x8,%eax
    3960:	cd 40                	int    $0x40
    3962:	c3                   	ret

00003963 <link>:
SYSCALL(link)
    3963:	b8 13 00 00 00       	mov    $0x13,%eax
    3968:	cd 40                	int    $0x40
    396a:	c3                   	ret

0000396b <mkdir>:
SYSCALL(mkdir)
    396b:	b8 14 00 00 00       	mov    $0x14,%eax
    3970:	cd 40                	int    $0x40
    3972:	c3                   	ret

00003973 <chdir>:
SYSCALL(chdir)
    3973:	b8 09 00 00 00       	mov    $0x9,%eax
    3978:	cd 40                	int    $0x40
    397a:	c3                   	ret

0000397b <dup>:
SYSCALL(dup)
    397b:	b8 0a 00 00 00       	mov    $0xa,%eax
    3980:	cd 40                	int    $0x40
    3982:	c3                   	ret

00003983 <getpid>:
SYSCALL(getpid)
    3983:	b8 0b 00 00 00       	mov    $0xb,%eax
    3988:	cd 40                	int    $0x40
    398a:	c3                   	ret

0000398b <sbrk>:
SYSCALL(sbrk)
    398b:	b8 0c 00 00 00       	mov    $0xc,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret

00003993 <sleep>:
SYSCALL(sleep)
    3993:	b8 0d 00 00 00       	mov    $0xd,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret

0000399b <uptime>:
SYSCALL(uptime)
    399b:	b8 0e 00 00 00       	mov    $0xe,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret
...
000039ab <join>:
SYSCALL(join)
    39ab:	b8 17 00 00 00       	mov    $0x17,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret

000039b3 <init_lock>:
SYSCALL(init_lock)
    39b3:	b8 18 00 00 00       	mov    $0x18,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret

000039bb <acquire_lock>:
SYSCALL(acquire_lock)
    39bb:	b8 19 00 00 00       	mov    $0x19,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret

000039c3 <release_lock>:
SYSCALL(release_lock)
    39c3:	b8 1a 00 00 00       	mov    $0x1a,%eax
    39c8:	cd 40                	int    $0x40
    39ca:	c3                   	ret

000039cb <init_sem>:
SYSCALL(init_sem)
    39cb:	b8 1b 00 00 00       	mov    $0x1b,%eax
    39d0:	cd 40                	int    $0x40
    39d2:	c3                   	ret

000039d3 <up_sem>:
SYSCALL(up_sem)
    39d3:	b8 1c 00 00 00       	mov    $0x1c,%eax
    39d8:	cd 40                	int    $0x40
    39da:	c3                   	ret

000039db <down_sem>:
    39db:	b8 1d 00 00 00       	mov    $0x1d,%eax
    39e0:	cd 40                	int    $0x40
    39e2:	c3                   	ret
...
{
    39fa:	83 ec 3c             	sub    $0x3c,%esp
    39fd:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    3a00:	85 d2                	test   %edx,%edx
    3a02:	0f 89 80 00 00 00    	jns    3a88 <printint+0x98>
    3a08:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3a0c:	74 7a                	je     3a88 <printint+0x98>
    x = -xx;
    3a0e:	f7 d9                	neg    %ecx
    neg = 1;
    3a10:	b8 01 00 00 00       	mov    $0x1,%eax
  } else {
    x = xx;
  }

  i = 0;
    3a15:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    3a18:	31 f6                	xor    %esi,%esi
  ...
  do{
    ...
    3a2b:	0f b6 92 90 55 00 00 	movzbl 0x5590(%edx),%edx
    3a32:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    3a36:	89 ca                	mov    %ecx,%edx
    3a38:	89 c1                	mov    %eax,%ecx
    3a3a:	39 da                	cmp    %ebx,%edx
    3a3c:	73 e2                	jae    3a20 <printint+0x30>
  if(neg)
    3a3e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3a41:	85 c0                	test   %eax,%eax
    3a43:	74 07                	je     3a4c <printint+0x5c>
    buf[i++] = '-';
    3a45:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    3a4a:	89 f7                	mov    %esi,%edi
    3a4c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    3a4f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    3a52:	01 df                	add    %ebx,%edi
    3a54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    3a58:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    3a5b:	83 ec 04             	sub    $0x4,%esp
    3a5e:	88 45 d7             	mov    %al,-0x29(%ebp)
    3a61:	8d 45 d7             	lea    -0x29(%ebp),%eax
    3a64:	6a 01                	push   $0x1
    3a66:	50                   	push   %eax
    3a67:	56                   	push   %esi
    3a68:	e8 b6 fe ff ff       	call   3923 <write>
  while(--i >= 0)
    3a6d:	89 f8                	mov    %edi,%eax
    3a6f:	83 c4 10             	add    $0x10,%esp
    3a72:	83 ef 01             	sub    $0x1,%edi
    3a75:	39 c3                	cmp    %eax,%ebx
    3a77:	75 df                	jne    3a58 <printint+0x68>
}
    3a79:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a7c:	5b                   	pop    %ebx
    3a7d:	5e                   	pop    %esi
    3a7e:	5f                   	pop    %edi
    3a7f:	5d                   	pop    %ebp
  ...
  neg = 0;
    3a88:	31 c0                	xor    %eax,%eax
    3a8a:	eb 89                	jmp    3a15 <printint+0x25>
...
{
    3a9c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    3a9f:	0f b6 1e             	movzbl (%esi),%ebx
    3aa2:	83 c6 01             	add    $0x1,%esi
    3aa5:	84 db                	test   %bl,%bl
    3aa7:	74 67                	je     3b10 <printf+0x80>
    3aa9:	8d 4d 10             	lea    0x10(%ebp),%ecx
    3aac:	31 d2                	xor    %edx,%edx
    3aae:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    3ab1:	eb 34                	jmp    3ae7 <printf+0x57>
    3ab3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    3ab8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3abb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    3ac0:	83 f8 25             	cmp    $0x25,%eax
    3ac3:	74 18                	je     3add <printf+0x4d>
  write(fd, &c, 1);
    3ac5:	83 ec 04             	sub    $0x4,%esp
    3ac8:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3acb:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3ace:	6a 01                	push   $0x1
    3ad0:	50                   	push   %eax
    3ad1:	57                   	push   %edi
    3ad2:	e8 4c fe ff ff       	call   3923 <write>
    3ad7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3ada:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3add:	0f b6 1e             	movzbl (%esi),%ebx
    3ae0:	83 c6 01             	add    $0x1,%esi
    3ae3:	84 db                	test   %bl,%bl
    3ae5:	74 29                	je     3b10 <printf+0x80>
    c = fmt[i] & 0xff;
    3ae7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3aea:	85 d2                	test   %edx,%edx
    3aec:	74 ca                	je     3ab8 <printf+0x28>
      }
    } else if(state == '%'){
    3aee:	83 fa 25             	cmp    $0x25,%edx
    3af1:	75 ea                	jne    3add <printf+0x4d>
      if(c == 'd'){
    3af3:	83 f8 25             	cmp    $0x25,%eax
    3af6:	0f 84 04 01 00 00    	je     3c00 <printf+0x170>
    3afc:	83 e8 63             	sub    $0x63,%eax
    3aff:	83 f8 15             	cmp    $0x15,%eax
    3b02:	77 1c                	ja     3b20 <printf+0x90>
    3b04:	ff 24 85 38 55 00 00 	jmp    *0x5538(,%eax,4)
    3b0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    3b16:	5d                   	pop    %ebp
    3b17:	c3                   	ret
    3b18:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3b1f:	00 
  write(fd, &c, 1);
    3b20:	83 ec 04             	sub    $0x4,%esp
    3b23:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3b26:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3b2a:	6a 01                	push   $0x1
    3b2c:	52                   	push   %edx
    3b2d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3b30:	57                   	push   %edi
    3b31:	e8 ed fd ff ff       	call   3923 <write>
    3b36:	83 c4 0c             	add    $0xc,%esp
    3b39:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3b3c:	6a 01                	push   $0x1
    3b3e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    3b41:	52                   	push   %edx
    3b42:	57                   	push   %edi
    3b43:	e8 db fd ff ff       	call   3923 <write>
        putc(fd, c);
    3b48:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b4b:	31 d2                	xor    %edx,%edx
    3b4d:	eb 8e                	jmp    3add <printf+0x4d>
    3b4f:	90                   	nop
        printint(fd, *ap, 16, 0);
    3b50:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3b53:	83 ec 0c             	sub    $0xc,%esp
    3b56:	b9 10 00 00 00       	mov    $0x10,%ecx
    3b5b:	8b 13                	mov    (%ebx),%edx
    3b5d:	6a 00                	push   $0x0
    3b5f:	89 f8                	mov    %edi,%eax
        ap++;
    3b61:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    3b64:	e8 87 fe ff ff       	call   39f0 <printint>
        ap++;
    3b69:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3b6c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b6f:	31 d2                	xor    %edx,%edx
    3b71:	e9 67 ff ff ff       	jmp    3add <printf+0x4d>
        s = (char*)*ap;
    3b76:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3b79:	8b 18                	mov    (%eax),%ebx
        ap++;
    3b7b:	83 c0 04             	add    $0x4,%eax
    3b7e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3b81:	85 db                	test   %ebx,%ebx
    3b83:	0f 84 87 00 00 00    	je     3c10 <printf+0x180>
        while(*s != 0){
    3b89:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    3b8c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    3b8e:	84 c0                	test   %al,%al
    3b90:	0f 84 47 ff ff ff    	je     3add <printf+0x4d>
    3b96:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3b99:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    3b9c:	89 de                	mov    %ebx,%esi
    3b9e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    3bab:	53                   	push   %ebx
    3bac:	57                   	push   %edi
    3bad:	e8 71 fd ff ff       	call   3923 <write>
        while(*s != 0){
    3bb2:	0f b6 06             	movzbl (%esi),%eax
    3bb5:	83 c4 10             	add    $0x10,%esp
    3bb8:	84 c0                	test   %al,%al
    3bba:	75 e4                	jne    3ba0 <printf+0x110>
      state = 0;
    3bbc:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    3bbf:	31 d2                	xor    %edx,%edx
    3bc1:	e9 17 ff ff ff       	jmp    3add <printf+0x4d>
        printint(fd, *ap, 10, 1);
    3bc6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3bc9:	83 ec 0c             	sub    $0xc,%esp
    3bcc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3bd1:	8b 13                	mov    (%ebx),%edx
    3bd3:	6a 01                	push   $0x1
    3bd5:	eb 88                	jmp    3b5f <printf+0xcf>
        putc(fd, *ap);
    3bd7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    3bda:	83 ec 04             	sub    $0x4,%esp
    3bdd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    3be0:	8b 03                	mov    (%ebx),%eax
        ap++;
    3be2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    3be5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3be8:	6a 01                	push   $0x1
    3bea:	52                   	push   %edx
    3beb:	57                   	push   %edi
    3bec:	e8 32 fd ff ff       	call   3923 <write>
        ap++;
    3bf1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3bf4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bf7:	31 d2                	xor    %edx,%edx
    3bf9:	e9 df fe ff ff       	jmp    3add <printf+0x4d>
    3bfe:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    3c00:	83 ec 04             	sub    $0x4,%esp
    3c03:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3c06:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3c09:	6a 01                	push   $0x1
    3c0b:	e9 31 ff ff ff       	jmp    3b41 <printf+0xb1>
    3c10:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    3c15:	bb b9 4d 00 00       	mov    $0x4db9,%ebx
    3c1a:	e9 77 ff ff ff       	jmp    3b96 <printf+0x106>
    3c1f:	90                   	nop
    ...
    3c21:	a1 60 a6 00 00       	mov    0xa660,%eax
{
  ...
  freep = p;
    ...
    3c5f:	5b                   	pop    %ebx
  freep = p;
    3c60:	a3 60 a6 00 00       	mov    %eax,0xa660
}
    3c65:	5e                   	pop    %esi
    3c66:	5f                   	pop    %edi
    3c67:	5d                   	pop    %ebp
    ...
    3c76:	72 ce                	jb     3c46 <free+0x26>
{
  ...
  freep = p;
    3c9a:	a3 60 a6 00 00       	mov    %eax,0xa660
    p->s.size += bp->s.size;
    3c9f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3ca2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3ca5:	89 08                	mov    %ecx,(%eax)
}
    3ca7:	5b                   	pop    %ebx
    3ca8:	5e                   	pop    %esi
    3ca9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 15 60 a6 00 00    	mov    0xa660,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    3ccd:	0f 84 8d 00 00 00    	je     3d60 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3cd8:	39 f9                	cmp    %edi,%ecx
    3cda:	73 64                	jae    3d40 <malloc+0x90>
  if(nu < 4096)
    3cdc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3ce1:	39 df                	cmp    %ebx,%edi
    3ce3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    3ce6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    3ced:	eb 0a                	jmp    3cf9 <malloc+0x49>
    3cef:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3cf0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3cf2:	8b 48 04             	mov    0x4(%eax),%ecx
    3cf5:	39 f9                	cmp    %edi,%ecx
    3cf7:	73 47                	jae    3d40 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3cf9:	89 c2                	mov    %eax,%edx
    3cfb:	3b 05 60 a6 00 00    	cmp    0xa660,%eax
    3d01:	75 ed                	jne    3cf0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    3d03:	83 ec 0c             	sub    $0xc,%esp
    3d06:	56                   	push   %esi
    3d07:	e8 7f fc ff ff       	call   398b <sbrk>
  if(p == (char*)-1)
    3d0c:	83 c4 10             	add    $0x10,%esp
    3d0f:	83 f8 ff             	cmp    $0xffffffff,%eax
    3d12:	74 1c                	je     3d30 <malloc+0x80>
  hp->s.size = nu;
    3d14:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3d17:	83 ec 0c             	sub    $0xc,%esp
    3d1a:	83 c0 08             	add    $0x8,%eax
    3d1d:	50                   	push   %eax
    3d1e:	e8 fd fe ff ff       	call   3c20 <free>
  return freep;
    3d23:	8b 15 60 a6 00 00    	mov    0xa660,%edx
      if((p = morecore(nunits)) == 0)
    3d29:	83 c4 10             	add    $0x10,%esp
    3d2c:	85 d2                	test   %edx,%edx
    3d2e:	75 c0                	jne    3cf0 <malloc+0x40>
        return 0;
  }
}
    3d30:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    3d33:	31 c0                	xor    %eax,%eax
}
    3d35:	5b                   	pop    %ebx
    3d36:	5e                   	pop    %esi
    3d37:	5f                   	pop    %edi
    ...
    3d42:	74 4c                	je     3d90 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    3d4c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d4f:	89 15 60 a6 00 00    	mov    %edx,0xa660
}
    ...
    3d5f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    3d60:	c7 05 60 a6 00 00 64 	movl   $0xa664,0xa660
    3d67:	a6 00 00 
    base.s.size = 0;
    3d6a:	b8 64 a6 00 00       	mov    $0xa664,%eax
    base.s.ptr = freep = prevp = &base;
    3d6f:	c7 05 64 a6 00 00 64 	movl   $0xa664,0xa664
    3d76:	a6 00 00 
    base.s.size = 0;
    3d79:	c7 05 68 a6 00 00 00 	movl   $0x0,0xa668
    3d80:	00 00 00 
    if(p->s.size >= nunits){
    3d83:	e9 54 ff ff ff       	jmp    3cdc <malloc+0x2c>
    3d88:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3d8f:	00 
        prevp->s.ptr = p->s.ptr;
    3d90:	8b 08                	mov    (%eax),%ecx
    3d92:	89 0a                	mov    %ecx,(%edx)
    3d94:	eb b9                	jmp    3d4f <malloc+0x9f>
