...
stat(const char *n, struct stat *st)
{
 ...
 1ed:	e8 21 01 00 00       	call   313 <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 24 01 00 00       	call   32b <fstat>
  close(fd);
 207:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 20a:	89 c6                	mov    %eax,%esi
  close(fd);
 20c:	e8 ea 00 00 00       	call   2fb <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 2ab:	e8 d0 03 00 00       	call   680 <malloc>

  if ((thread_id = clone(fn, arg, uva_stack)) < 0)
 2b0:	83 c4 0c             	add    $0xc,%esp
 2b3:	50                   	push   %eax
 2b4:	ff 75 0c             	push   0xc(%ebp)
 2b7:	ff 75 08             	push   0x8(%ebp)
 2ba:	e8 b4 00 00 00       	call   373 <clone>
 2bf:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
}
 2c4:	c9                   	leave
...
free(void *ap)
{
 ...
 5f1:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	3b 05 b0 0a 00 00    	cmp    0xab0,%eax
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 b4 0a 00 00       	mov    $0xab4,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 746:	0a 00 00 
    base.s.size = 0;
 749:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 750:	00 00 00 
    if(p->s.size >= nunits){
