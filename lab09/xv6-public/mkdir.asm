...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 17 03 00 00       	call   35b <mkdir>
  ...
  exit();
  5d:	e8 91 02 00 00       	call   2f3 <exit>
    printf(2, "Usage: mkdir files...\n");
  62:	52                   	push   %edx
  63:	52                   	push   %edx
  ...
  6b:	e8 10 04 00 00       	call   480 <printf>
    exit();
  70:	e8 7e 02 00 00       	call   2f3 <exit>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 21 01 00 00       	call   333 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 24 01 00 00       	call   34b <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 ea 00 00 00       	call   31b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 2cb:	e8 d0 03 00 00       	call   6a0 <malloc>
 ...
 2da:	e8 b4 00 00 00       	call   393 <clone>
 2df:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
}
 2e4:	c9                   	leave
 ...
 611:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6eb:	3b 05 e8 0a 00 00    	cmp    0xae8,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 ec 0a 00 00       	mov    $0xaec,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 766:	0a 00 00 
    base.s.size = 0;
 769:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 770:	00 00 00 
    if(p->s.size >= nunits){
