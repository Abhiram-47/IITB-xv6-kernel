...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 27b:	e8 d0 03 00 00       	call   650 <malloc>
 ...
 5c1:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 54 0a 00 00       	mov    %eax,0xa54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 54 0a 00 00    	mov    0xa54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 54 0a 00 00    	cmp    0xa54,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 54 0a 00 00    	mov    0xa54,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 58 0a 00 00       	mov    $0xa58,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 720:	00 00 00 
    if(p->s.size >= nunits){
