  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 f8 05 00 00       	push   $0x5f8
  4e:	e8 5d 01 00 00       	call   1b0 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 f8 05 00 00       	push   $0x5f8
  5c:	6a 01                	push   $0x1
  ...
  ab:	68 2a 06 00 00       	push   $0x62a
  b0:	e8 fb 00 00 00       	call   1b0 <strlen>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	50                   	push   %eax
  b9:	68 2a 06 00 00       	push   $0x62a
  be:	6a 01                	push   $0x1
  ...
  d2:	68 03 06 00 00       	push   $0x603
  d7:	e8 d4 00 00 00       	call   1b0 <strlen>
  dc:	83 c4 0c             	add    $0xc,%esp
  df:	50                   	push   %eax
  e0:	68 03 06 00 00       	push   $0x603
  e5:	6a 01                	push   $0x1
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 36b:	e8 a0 01 00 00       	call   510 <malloc>
...
free(void *ap)
{
 ...
 481:	a1 e4 08 00 00       	mov    0x8e4,%eax
{
 ...
 49c:	73 32                	jae    4d0 <free+0x50>
 49e:	39 d1                	cmp    %edx,%ecx
 4a0:	72 04                	jb     4a6 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 4a2:	39 d0                	cmp    %edx,%eax
 4a4:	72 32                	jb     4d8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
 4a6:	8b 73 fc             	mov    -0x4(%ebx),%esi
 4a9:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 4ac:	39 fa                	cmp    %edi,%edx
 4ae:	74 30                	je     4e0 <free+0x60>
 ...
 4b0:	89 53 f8             	mov    %edx,-0x8(%ebx)
    ...
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
 4b3:	8b 50 04             	mov    0x4(%eax),%edx
 4b6:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 4b9:	39 f1                	cmp    %esi,%ecx
 4bb:	74 3a                	je     4f7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
 4bd:	89 08                	mov    %ecx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
 4bf:	5b                   	pop    %ebx
  freep = p;
 4c0:	a3 e4 08 00 00       	mov    %eax,0x8e4
}
 4c5:	5e                   	pop    %esi
 4c6:	5f                   	pop    %edi
 4c7:	5d                   	pop    %ebp
 ...
 4d2:	72 04                	jb     4d8 <free+0x58>
 4d4:	39 d1                	cmp    %edx,%ecx
 4d6:	72 ce                	jb     4a6 <free+0x26>
{
 4d8:	89 d0                	mov    %edx,%eax
 4da:	eb bc                	jmp    498 <free+0x18>
 ...
 4f5:	75 c6                	jne    4bd <free+0x3d>
    p->s.size += bp->s.size;
 4f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 4fa:	a3 e4 08 00 00       	mov    %eax,0x8e4
    p->s.size += bp->s.size;
 4ff:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 502:	8b 4b f8             	mov    -0x8(%ebx),%ecx
...
malloc(uint nbytes)
{
 ...
 519:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 51c:	8b 15 e4 08 00 00    	mov    0x8e4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 522:	8d 78 07             	lea    0x7(%eax),%edi
 525:	c1 ef 03             	shr    $0x3,%edi
 528:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
 52b:	85 d2                	test   %edx,%edx
 52d:	0f 84 8d 00 00 00    	je     5c0 <malloc+0xb0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 533:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 535:	8b 48 04             	mov    0x4(%eax),%ecx
 538:	39 f9                	cmp    %edi,%ecx
 53a:	73 64                	jae    5a0 <malloc+0x90>
  if(nu < 4096)
 53c:	bb 00 10 00 00       	mov    $0x1000,%ebx
 541:	39 df                	cmp    %ebx,%edi
 543:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
 546:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 54d:	eb 0a                	jmp    559 <malloc+0x49>
 54f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 550:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 552:	8b 48 04             	mov    0x4(%eax),%ecx
 555:	39 f9                	cmp    %edi,%ecx
 557:	73 47                	jae    5a0 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 55b:	3b 05 e4 08 00 00    	cmp    0x8e4,%eax
 561:	75 ed                	jne    550 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 563:	83 ec 0c             	sub    $0xc,%esp
 566:	56                   	push   %esi
 567:	e8 af fe ff ff       	call   41b <sbrk>
  if(p == (char*)-1)
 56c:	83 c4 10             	add    $0x10,%esp
 56f:	83 f8 ff             	cmp    $0xffffffff,%eax
 572:	74 1c                	je     590 <malloc+0x80>
  hp->s.size = nu;
 ...
 57d:	50                   	push   %eax
 57e:	e8 fd fe ff ff       	call   480 <free>
  return freep;
 583:	8b 15 e4 08 00 00    	mov    0x8e4,%edx
      if((p = morecore(nunits)) == 0)
 589:	83 c4 10             	add    $0x10,%esp
 58c:	85 d2                	test   %edx,%edx
 58e:	75 c0                	jne    550 <malloc+0x40>
        return 0;
  }
}
 ...
 59a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
 5a0:	39 cf                	cmp    %ecx,%edi
 5a2:	74 4c                	je     5f0 <malloc+0xe0>
        p->s.size -= nunits;
 5a4:	29 f9                	sub    %edi,%ecx
 5a6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
 5a9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
 5ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 5af:	89 15 e4 08 00 00    	mov    %edx,0x8e4
}
 ...
 5bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 5c0:	c7 05 e4 08 00 00 e8 	movl   $0x8e8,0x8e4
 5c7:	08 00 00 
    base.s.size = 0;
 5ca:	b8 e8 08 00 00       	mov    $0x8e8,%eax
    base.s.ptr = freep = prevp = &base;
 5cf:	c7 05 e8 08 00 00 e8 	movl   $0x8e8,0x8e8
 5d6:	08 00 00 
    base.s.size = 0;
 5d9:	c7 05 ec 08 00 00 00 	movl   $0x0,0x8ec
 5e0:	00 00 00 
    if(p->s.size >= nunits){
 5e3:	e9 54 ff ff ff       	jmp    53c <malloc+0x2c>
 5e8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 5ef:	00 
        prevp->s.ptr = p->s.ptr;
 5f0:	8b 08                	mov    (%eax),%ecx
 5f2:	89 0a                	mov    %ecx,(%edx)
 5f4:	eb b9                	jmp    5af <malloc+0x9f>
