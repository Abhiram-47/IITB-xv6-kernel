...
fork1(void)
{
  ...
  exit();
     ...
     105:	51                   	push   %ecx
     106:	68 23 1a 00 00       	push   $0x1a23
     10b:	68 71 13 00 00       	push   $0x1371
     110:	6a 02                	push   $0x2
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 88 13 00 00 	jmp    *0x1388(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    panic("runcmd");
     ...
     2d2:	68 f7 12 00 00       	push   $0x12f7
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     337:	6a 54                	push   $0x54
     339:	e8 a2 0e 00 00       	call   11e0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     367:	6a 18                	push   $0x18
     369:	e8 72 0e 00 00       	call   11e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3b7:	6a 0c                	push   $0xc
     3b9:	e8 22 0e 00 00       	call   11e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3f7:	6a 0c                	push   $0xc
     3f9:	e8 e2 0d 00 00       	call   11e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     437:	6a 08                	push   $0x8
     439:	e8 a2 0d 00 00       	call   11e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 00 1a 00 00       	push   $0x1a00
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 00 1a 00 00       	push   $0x1a00
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 f8 19 00 00       	push   $0x19f8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 00 1a 00 00       	push   $0x1a00
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 00 1a 00 00       	push   $0x1a00
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac5:	ff 24 85 a0 13 00 00 	jmp    *0x13a0(,%eax,4)
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b73:	68 e6 12 00 00       	push   $0x12e6
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 5a 13 00 00       	push   $0x135a
     ba5:	6a 02                	push   $0x2
     ba7:	e8 14 04 00 00       	call   fc0 <printf>
    panic("syntax");
     bac:	c7 04 24 1e 13 00 00 	movl   $0x131e,(%esp)
     ...
     ce9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     cf5:	56                   	push   %esi
     cf6:	6a 00                	push   $0x0
     cf8:	e8 4e 01 00 00       	call   e4b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d4d:	e8 21 01 00 00       	call   e73 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d61:	50                   	push   %eax
     d62:	e8 24 01 00 00       	call   e8b <fstat>
  close(fd);
     d67:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d6a:	89 c6                	mov    %eax,%esi
  close(fd);
     d6c:	e8 ea 00 00 00       	call   e5b <close>
  return r;
...
00000e00 <create_thread>:

int create_thread(void(*fn)(int*), int *arg)
{
     e00:	55                   	push   %ebp
     e01:	89 e5                	mov    %esp,%ebp
     e03:	83 ec 14             	sub    $0x14,%esp
  int thread_id;
  void* uva_stack = malloc(4096);
     e06:	68 00 10 00 00       	push   $0x1000
     e0b:	e8 d0 03 00 00       	call   11e0 <malloc>
  ...
  if ((thread_id = clone(fn, arg, uva_stack)) < 0)
     ...
     e1a:	e8 b4 00 00 00       	call   ed3 <clone>
     e1f:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
}
     e24:	c9                   	leave
...
00000efb <init_sem>:
SYSCALL(init_sem)
     efb:	b8 1b 00 00 00       	mov    $0x1b,%eax
     f00:	cd 40                	int    $0x40
     f02:	c3                   	ret

00000f03 <up_sem>:
SYSCALL(up_sem)
     f03:	b8 1c 00 00 00       	mov    $0x1c,%eax
     f08:	cd 40                	int    $0x40
     f0a:	c3                   	ret

00000f0b <down_sem>:
     f0b:	b8 1d 00 00 00       	mov    $0x1d,%eax
     f10:	cd 40                	int    $0x40
     f12:	c3                   	ret
...
{
     f2a:	83 ec 3c             	sub    $0x3c,%esp
     f2d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
     f30:	85 d2                	test   %edx,%edx
     f32:	0f 89 80 00 00 00    	jns    fb8 <printint+0x98>
     f38:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
     f3c:	74 7a                	je     fb8 <printint+0x98>
    x = -xx;
     f3e:	f7 d9                	neg    %ecx
    neg = 1;
     f40:	b8 01 00 00 00       	mov    $0x1,%eax
  } else {
    x = xx;
  }

  i = 0;
     f45:	89 45 c4             	mov    %eax,-0x3c(%ebp)
     f48:	31 f6                	xor    %esi,%esi
     f4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
     f50:	89 c8                	mov    %ecx,%eax
     f52:	31 d2                	xor    %edx,%edx
     f54:	89 f7                	mov    %esi,%edi
     f56:	f7 f3                	div    %ebx
     f58:	8d 76 01             	lea    0x1(%esi),%esi
     f5b:	0f b6 92 10 14 00 00 	movzbl 0x1410(%edx),%edx
     f62:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
     f66:	89 ca                	mov    %ecx,%edx
     f68:	89 c1                	mov    %eax,%ecx
     f6a:	39 da                	cmp    %ebx,%edx
     f6c:	73 e2                	jae    f50 <printint+0x30>
  if(neg)
     f6e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     f71:	85 c0                	test   %eax,%eax
     f73:	74 07                	je     f7c <printint+0x5c>
    buf[i++] = '-';
     f75:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
     f7a:	89 f7                	mov    %esi,%edi
     f7c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
     f7f:	8b 75 c0             	mov    -0x40(%ebp),%esi
     f82:	01 df                	add    %ebx,%edi
     f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
     f88:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
     f8b:	83 ec 04             	sub    $0x4,%esp
     f8e:	88 45 d7             	mov    %al,-0x29(%ebp)
     f91:	8d 45 d7             	lea    -0x29(%ebp),%eax
     f94:	6a 01                	push   $0x1
     f96:	50                   	push   %eax
     f97:	56                   	push   %esi
     f98:	e8 b6 fe ff ff       	call   e53 <write>
  while(--i >= 0)
     f9d:	89 f8                	mov    %edi,%eax
     f9f:	83 c4 10             	add    $0x10,%esp
     fa2:	83 ef 01             	sub    $0x1,%edi
     fa5:	39 c3                	cmp    %eax,%ebx
     fa7:	75 df                	jne    f88 <printint+0x68>
}
     fa9:	8d 65 f4             	lea    -0xc(%ebp),%esp
     fac:	5b                   	pop    %ebx
     fad:	5e                   	pop    %esi
     fae:	5f                   	pop    %edi
     faf:	5d                   	pop    %ebp
  ...
  neg = 0;
     ...
     fba:	eb 89                	jmp    f45 <printint+0x25>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     fc9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
     fcc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
     fcf:	0f b6 1e             	movzbl (%esi),%ebx
     fd2:	83 c6 01             	add    $0x1,%esi
     fd5:	84 db                	test   %bl,%bl
     fd7:	74 67                	je     1040 <printf+0x80>
     fd9:	8d 4d 10             	lea    0x10(%ebp),%ecx
     fdc:	31 d2                	xor    %edx,%edx
     fde:	89 4d d0             	mov    %ecx,-0x30(%ebp)
     fe1:	eb 34                	jmp    1017 <printf+0x57>
     fe3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
     fe8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
     feb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
     ff0:	83 f8 25             	cmp    $0x25,%eax
     ff3:	74 18                	je     100d <printf+0x4d>
  write(fd, &c, 1);
     ff5:	83 ec 04             	sub    $0x4,%esp
     ff8:	8d 45 e7             	lea    -0x19(%ebp),%eax
     ffb:	88 5d e7             	mov    %bl,-0x19(%ebp)
     ffe:	6a 01                	push   $0x1
    1000:	50                   	push   %eax
    1001:	57                   	push   %edi
    1002:	e8 4c fe ff ff       	call   e53 <write>
    1007:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    100a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    100d:	0f b6 1e             	movzbl (%esi),%ebx
    1010:	83 c6 01             	add    $0x1,%esi
    1013:	84 db                	test   %bl,%bl
    1015:	74 29                	je     1040 <printf+0x80>
    c = fmt[i] & 0xff;
    1017:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    101a:	85 d2                	test   %edx,%edx
    101c:	74 ca                	je     fe8 <printf+0x28>
      }
    } else if(state == '%'){
    101e:	83 fa 25             	cmp    $0x25,%edx
    1021:	75 ea                	jne    100d <printf+0x4d>
      if(c == 'd'){
    1023:	83 f8 25             	cmp    $0x25,%eax
    1026:	0f 84 04 01 00 00    	je     1130 <printf+0x170>
    102c:	83 e8 63             	sub    $0x63,%eax
    102f:	83 f8 15             	cmp    $0x15,%eax
    1032:	77 1c                	ja     1050 <printf+0x90>
    1034:	ff 24 85 b8 13 00 00 	jmp    *0x13b8(,%eax,4)
    103b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1053:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1056:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    105a:	6a 01                	push   $0x1
    105c:	52                   	push   %edx
    105d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1060:	57                   	push   %edi
    1061:	e8 ed fd ff ff       	call   e53 <write>
    1066:	83 c4 0c             	add    $0xc,%esp
    1069:	88 5d e7             	mov    %bl,-0x19(%ebp)
    106c:	6a 01                	push   $0x1
    106e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1071:	52                   	push   %edx
    1072:	57                   	push   %edi
    1073:	e8 db fd ff ff       	call   e53 <write>
        putc(fd, c);
    1078:	83 c4 10             	add    $0x10,%esp
      state = 0;
    107b:	31 d2                	xor    %edx,%edx
    107d:	eb 8e                	jmp    100d <printf+0x4d>
    107f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1080:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1083:	83 ec 0c             	sub    $0xc,%esp
    1086:	b9 10 00 00 00       	mov    $0x10,%ecx
    108b:	8b 13                	mov    (%ebx),%edx
    108d:	6a 00                	push   $0x0
    108f:	89 f8                	mov    %edi,%eax
        ap++;
    1091:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1094:	e8 87 fe ff ff       	call   f20 <printint>
        ap++;
    1099:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    109c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    109f:	31 d2                	xor    %edx,%edx
    10a1:	e9 67 ff ff ff       	jmp    100d <printf+0x4d>
        s = (char*)*ap;
    10a6:	8b 45 d0             	mov    -0x30(%ebp),%eax
    10a9:	8b 18                	mov    (%eax),%ebx
        ap++;
    10ab:	83 c0 04             	add    $0x4,%eax
    10ae:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    10b1:	85 db                	test   %ebx,%ebx
    10b3:	0f 84 87 00 00 00    	je     1140 <printf+0x180>
        while(*s != 0){
    10b9:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    10bc:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    10be:	84 c0                	test   %al,%al
    10c0:	0f 84 47 ff ff ff    	je     100d <printf+0x4d>
    10c6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    10c9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    10cc:	89 de                	mov    %ebx,%esi
    10ce:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    10f1:	e9 17 ff ff ff       	jmp    100d <printf+0x4d>
        printint(fd, *ap, 10, 1);
    10f6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    10f9:	83 ec 0c             	sub    $0xc,%esp
    10fc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1101:	8b 13                	mov    (%ebx),%edx
    1103:	6a 01                	push   $0x1
    1105:	eb 88                	jmp    108f <printf+0xcf>
        putc(fd, *ap);
    1107:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    110a:	83 ec 04             	sub    $0x4,%esp
    110d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    1110:	8b 03                	mov    (%ebx),%eax
        ap++;
    1112:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    1115:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1118:	6a 01                	push   $0x1
    111a:	52                   	push   %edx
    111b:	57                   	push   %edi
    111c:	e8 32 fd ff ff       	call   e53 <write>
        ap++;
    1121:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1124:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1127:	31 d2                	xor    %edx,%edx
    1129:	e9 df fe ff ff       	jmp    100d <printf+0x4d>
    112e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1130:	83 ec 04             	sub    $0x4,%esp
    1133:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1136:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1139:	6a 01                	push   $0x1
    113b:	e9 31 ff ff ff       	jmp    1071 <printf+0xb1>
    1140:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1145:	bb 7f 13 00 00       	mov    $0x137f,%ebx
    114a:	e9 77 ff ff ff       	jmp    10c6 <printf+0x106>
    114f:	90                   	nop
    ...
    1151:	a1 84 1a 00 00       	mov    0x1a84,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    116a:	39 c8                	cmp    %ecx,%eax
    116c:	73 32                	jae    11a0 <free+0x50>
    116e:	39 d1                	cmp    %edx,%ecx
    1170:	72 04                	jb     1176 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1172:	39 d0                	cmp    %edx,%eax
    1174:	72 32                	jb     11a8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1176:	8b 73 fc             	mov    -0x4(%ebx),%esi
    1179:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    117c:	39 fa                	cmp    %edi,%edx
    117e:	74 30                	je     11b0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    1180:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    1183:	8b 50 04             	mov    0x4(%eax),%edx
    1186:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    1189:	39 f1                	cmp    %esi,%ecx
    118b:	74 3a                	je     11c7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    118d:	89 08                	mov    %ecx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
    118f:	5b                   	pop    %ebx
  freep = p;
    1190:	a3 84 1a 00 00       	mov    %eax,0x1a84
}
    1195:	5e                   	pop    %esi
    1196:	5f                   	pop    %edi
    1197:	5d                   	pop    %ebp
    ...
    11a2:	72 04                	jb     11a8 <free+0x58>
    11a4:	39 d1                	cmp    %edx,%ecx
    11a6:	72 ce                	jb     1176 <free+0x26>
{
    11a8:	89 d0                	mov    %edx,%eax
    11aa:	eb bc                	jmp    1168 <free+0x18>
    11ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
    11b0:	03 72 04             	add    0x4(%edx),%esi
    11b3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    11b6:	8b 10                	mov    (%eax),%edx
    11b8:	8b 12                	mov    (%edx),%edx
    11ba:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    11bd:	8b 50 04             	mov    0x4(%eax),%edx
    11c0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    11c3:	39 f1                	cmp    %esi,%ecx
    11c5:	75 c6                	jne    118d <free+0x3d>
    p->s.size += bp->s.size;
    11c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    11ca:	a3 84 1a 00 00       	mov    %eax,0x1a84
    p->s.size += bp->s.size;
    11cf:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    11d2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    11d5:	89 08                	mov    %ecx,(%eax)
}
    11d7:	5b                   	pop    %ebx
    11d8:	5e                   	pop    %esi
    11d9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11ec:	8b 15 84 1a 00 00    	mov    0x1a84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    11f2:	8d 78 07             	lea    0x7(%eax),%edi
    11f5:	c1 ef 03             	shr    $0x3,%edi
    11f8:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    11fb:	85 d2                	test   %edx,%edx
    11fd:	0f 84 8d 00 00 00    	je     1290 <malloc+0xb0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1203:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1205:	8b 48 04             	mov    0x4(%eax),%ecx
    1208:	39 f9                	cmp    %edi,%ecx
    120a:	73 64                	jae    1270 <malloc+0x90>
  if(nu < 4096)
    120c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1211:	39 df                	cmp    %ebx,%edi
    1213:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    1216:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    121d:	eb 0a                	jmp    1229 <malloc+0x49>
    121f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1220:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1222:	8b 48 04             	mov    0x4(%eax),%ecx
    1225:	39 f9                	cmp    %edi,%ecx
    1227:	73 47                	jae    1270 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    122b:	3b 05 84 1a 00 00    	cmp    0x1a84,%eax
    1231:	75 ed                	jne    1220 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1233:	83 ec 0c             	sub    $0xc,%esp
    1236:	56                   	push   %esi
    1237:	e8 7f fc ff ff       	call   ebb <sbrk>
  if(p == (char*)-1)
    123c:	83 c4 10             	add    $0x10,%esp
    123f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1242:	74 1c                	je     1260 <malloc+0x80>
  hp->s.size = nu;
    1244:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1247:	83 ec 0c             	sub    $0xc,%esp
    124a:	83 c0 08             	add    $0x8,%eax
    124d:	50                   	push   %eax
    124e:	e8 fd fe ff ff       	call   1150 <free>
  return freep;
    1253:	8b 15 84 1a 00 00    	mov    0x1a84,%edx
      if((p = morecore(nunits)) == 0)
    1259:	83 c4 10             	add    $0x10,%esp
    125c:	85 d2                	test   %edx,%edx
    125e:	75 c0                	jne    1220 <malloc+0x40>
        return 0;
  }
}
    ...
    126a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    1270:	39 cf                	cmp    %ecx,%edi
    1272:	74 4c                	je     12c0 <malloc+0xe0>
        p->s.size -= nunits;
    1274:	29 f9                	sub    %edi,%ecx
    1276:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    1279:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    127c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    127f:	89 15 84 1a 00 00    	mov    %edx,0x1a84
}
    ...
    128f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1290:	c7 05 84 1a 00 00 88 	movl   $0x1a88,0x1a84
    1297:	1a 00 00 
    base.s.size = 0;
    129a:	b8 88 1a 00 00       	mov    $0x1a88,%eax
    base.s.ptr = freep = prevp = &base;
    129f:	c7 05 88 1a 00 00 88 	movl   $0x1a88,0x1a88
    12a6:	1a 00 00 
    base.s.size = 0;
    12a9:	c7 05 8c 1a 00 00 00 	movl   $0x0,0x1a8c
    12b0:	00 00 00 
    if(p->s.size >= nunits){
    12b3:	e9 54 ff ff ff       	jmp    120c <malloc+0x2c>
    12b8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    12bf:	00 
        prevp->s.ptr = p->s.ptr;
    12c0:	8b 08                	mov    (%eax),%ecx
    12c2:	89 0a                	mov    %ecx,(%edx)
    12c4:	eb b9                	jmp    127f <malloc+0x9f>
