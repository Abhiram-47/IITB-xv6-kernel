...
int main(int argc, char *argv[])
{
  ...
  17:	50                   	push   %eax
  18:	e8 8e 03 00 00       	call   3ab <getpasize>
  ...
  27:	e8 57 03 00 00       	call   383 <getvasize>
  2c:	83 c4 0c             	add    $0xc,%esp
  2f:	c1 e8 0c             	shr    $0xc,%eax
  32:	50                   	push   %eax
  33:	68 68 07 00 00       	push   $0x768
  38:	6a 01                	push   $0x1
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d4:	ff 24 85 54 08 00 00 	jmp    *0x854(,%eax,4)
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 4c 08 00 00       	mov    $0x84c,%ebx
...
free(void *ap)
{
 ...
 5f1:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	3b 05 4c 0b 00 00    	cmp    0xb4c,%eax
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 71f:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 ...
 72f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 737:	0b 00 00 
    base.s.size = 0;
 73a:	b8 50 0b 00 00       	mov    $0xb50,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 746:	0b 00 00 
    base.s.size = 0;
 749:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 750:	00 00 00 
    if(p->s.size >= nunits){
