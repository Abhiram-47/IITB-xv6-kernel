...
main(int argc, char *argv[])
{
  ...
  17:	50                   	push   %eax
  18:	68 38 07 00 00       	push   $0x738
  1d:	6a 01                	push   $0x1
  1f:	e8 0c 04 00 00       	call   430 <printf>
  char *sbrk_before=sbrk(0);
  24:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  2b:	e8 0b 03 00 00       	call   33b <sbrk>
