 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4c4:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 05 08 00 00       	mov    $0x805,%ebx
 ...
 5e1:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bb:	3b 05 04 0b 00 00    	cmp    0xb04,%eax
