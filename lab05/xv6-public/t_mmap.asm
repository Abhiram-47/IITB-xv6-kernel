 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 c8 07 00 00 	jmp    *0x7c8(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb be 07 00 00       	mov    $0x7be,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 c0 0a 00 00    	cmp    0xac0,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 ...
 70f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 c4 0a 00 00       	mov    $0xac4,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 730:	00 00 00 
    if(p->s.size >= nunits){
