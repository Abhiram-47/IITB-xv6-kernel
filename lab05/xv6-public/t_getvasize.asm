...
int main(int argc, char *argv[])
{
  ...
  64:	e8 02 03 00 00       	call   36b <sbrk>
  69:	89 c3                	mov    %eax,%ebx
  int process_size_after_sbrk = getvasize(getpid());
  6b:	e8 f3 02 00 00       	call   363 <getpid>
  70:	89 04 24             	mov    %eax,(%esp)
  73:	e8 0b 03 00 00       	call   383 <getvasize>
  printf(1, "Size of process:          %d Bytes\n", process_size_after_sbrk);
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	50                   	push   %eax
  7c:	68 8c 07 00 00       	push   $0x78c
  81:	6a 01                	push   $0x1
  83:	e8 d8 03 00 00       	call   460 <printf>
  printf(1, "Address returned by sbrk: x0%x\n", sbrk_after);
  88:	83 c4 0c             	add    $0xc,%esp
  8b:	53                   	push   %ebx
  8c:	68 d0 07 00 00       	push   $0x7d0
  91:	6a 01                	push   $0x1
  93:	e8 c8 03 00 00       	call   460 <printf>

  exit();
  98:	e8 46 02 00 00       	call   2e3 <exit>
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 48 08 00 00 	movzbl 0x848(%edx),%edx
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d4:	ff 24 85 f0 07 00 00 	jmp    *0x7f0(,%eax,4)
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 82 07 00 00       	mov    $0x782,%ebx
...
free(void *ap)
{
 ...
 5f1:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 e8 0a 00 00       	mov    %eax,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	3b 05 e8 0a 00 00    	cmp    0xae8,%eax
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 ec 0a 00 00       	mov    $0xaec,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 746:	0a 00 00 
    base.s.size = 0;
 749:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 750:	00 00 00 
    if(p->s.size >= nunits){
