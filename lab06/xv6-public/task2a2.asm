...
_task2a2:     file format elf32-i386
   ...
   f:	be 05 00 00 00       	mov    $0x5,%esi
{
  ...
  31:	89 c3                	mov    %eax,%ebx
        set_priority(pid, priority);
  33:	50                   	push   %eax
  34:	e8 1a 04 00 00       	call   453 <set_priority>


        if (pid < 0)
  39:	83 c4 10             	add    $0x10,%esp
  3c:	85 db                	test   %ebx,%ebx
  3e:	78 42                	js     82 <main+0x82>
        {
            printf(1, "%d failed in fork!\n", getpid());
            exit();
        }
        else if (pid == 0)
  40:	74 58                	je     9a <main+0x9a>
    for (int child = 1; child <= 3; child++)
  42:	83 c6 01             	add    $0x1,%esi
  45:	83 fe 08             	cmp    $0x8,%esi
  48:	75 de                	jne    28 <main+0x28>
  4a:	bb 03 00 00 00       	mov    $0x3,%ebx
  4f:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  52:	8d 75 e0             	lea    -0x20(%ebp),%esi
  ...
  58:	57                   	push   %edi
  59:	56                   	push   %esi
  5a:	e8 ec 03 00 00       	call   44b <wait2>
        printf(1, "Child pid: %d exited with pid: %d, Waiting Time: %d, Run Time: %d\n", status, status, wtime, rtime);
  5f:	5a                   	pop    %edx
  60:	59                   	pop    %ecx
  61:	ff 75 e4             	push   -0x1c(%ebp)
  64:	ff 75 e0             	push   -0x20(%ebp)
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 cc 08 00 00       	push   $0x8cc
  6e:	6a 01                	push   $0x1
  70:	e8 9b 04 00 00       	call   510 <printf>
    for (int i = 1; i <= 3; i++)
  75:	83 c4 20             	add    $0x20,%esp
  78:	83 eb 01             	sub    $0x1,%ebx
  7b:	75 d8                	jne    55 <main+0x55>
    }

    exit();
  7d:	e8 21 03 00 00       	call   3a3 <exit>
            printf(1, "%d failed in fork!\n", getpid());
  82:	e8 9c 03 00 00       	call   423 <getpid>
  87:	53                   	push   %ebx
  88:	50                   	push   %eax
  ...
  9d:	56                   	push   %esi
  9e:	e8 0d 00 00 00       	call   b0 <computation>
  a3:	66 90                	xchg   %ax,%ax
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
