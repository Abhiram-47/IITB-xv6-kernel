...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 57b:	e8 c0 03 00 00       	call   940 <malloc>
 ...
 688:	89 d1                	mov    %edx,%ecx
{
 ...
 68d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
 690:	85 d2                	test   %edx,%edx
 692:	0f 89 80 00 00 00    	jns    718 <printint+0x98>
 698:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
 69c:	74 7a                	je     718 <printint+0x98>
    x = -xx;
 69e:	f7 d9                	neg    %ecx
    neg = 1;
 ...
 6b4:	89 f7                	mov    %esi,%edi
 6b6:	f7 f3                	div    %ebx
 6b8:	8d 76 01             	lea    0x1(%esi),%esi
 6bb:	0f b6 92 d4 0a 00 00 	movzbl 0xad4(%edx),%edx
 6c2:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
 6c6:	89 ca                	mov    %ecx,%edx
 6c8:	89 c1                	mov    %eax,%ecx
 6ca:	39 da                	cmp    %ebx,%edx
 6cc:	73 e2                	jae    6b0 <printint+0x30>
  if(neg)
 6ce:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 6d1:	85 c0                	test   %eax,%eax
 6d3:	74 07                	je     6dc <printint+0x5c>
    buf[i++] = '-';
 6d5:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
 6da:	89 f7                	mov    %esi,%edi
 6dc:	8d 5d d8             	lea    -0x28(%ebp),%ebx
 6df:	8b 75 c0             	mov    -0x40(%ebp),%esi
 6e2:	01 df                	add    %ebx,%edi
 6e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
 6e8:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
 6eb:	83 ec 04             	sub    $0x4,%esp
 6ee:	88 45 d7             	mov    %al,-0x29(%ebp)
 6f1:	8d 45 d7             	lea    -0x29(%ebp),%eax
 6f4:	6a 01                	push   $0x1
 6f6:	50                   	push   %eax
 6f7:	56                   	push   %esi
 6f8:	e8 c6 fe ff ff       	call   5c3 <write>
  while(--i >= 0)
 6fd:	89 f8                	mov    %edi,%eax
 6ff:	83 c4 10             	add    $0x10,%esp
 702:	83 ef 01             	sub    $0x1,%edi
 705:	39 c3                	cmp    %eax,%ebx
 707:	75 df                	jne    6e8 <printint+0x68>
}
 ...
 71a:	eb 89                	jmp    6a5 <printint+0x25>
 ...
 729:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 732:	83 c6 01             	add    $0x1,%esi
 735:	84 db                	test   %bl,%bl
 737:	74 67                	je     7a0 <printf+0x80>
 739:	8d 4d 10             	lea    0x10(%ebp),%ecx
 73c:	31 d2                	xor    %edx,%edx
 73e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
 741:	eb 34                	jmp    777 <printf+0x57>
 743:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
 748:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
 ...
 753:	74 18                	je     76d <printf+0x4d>
  write(fd, &c, 1);
 755:	83 ec 04             	sub    $0x4,%esp
 758:	8d 45 e7             	lea    -0x19(%ebp),%eax
 75b:	88 5d e7             	mov    %bl,-0x19(%ebp)
 75e:	6a 01                	push   $0x1
 760:	50                   	push   %eax
 761:	57                   	push   %edi
 762:	e8 5c fe ff ff       	call   5c3 <write>
 767:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
 76a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
 76d:	0f b6 1e             	movzbl (%esi),%ebx
 770:	83 c6 01             	add    $0x1,%esi
 773:	84 db                	test   %bl,%bl
 775:	74 29                	je     7a0 <printf+0x80>
    c = fmt[i] & 0xff;
 777:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 77a:	85 d2                	test   %edx,%edx
 77c:	74 ca                	je     748 <printf+0x28>
      }
    } else if(state == '%'){
 77e:	83 fa 25             	cmp    $0x25,%edx
 781:	75 ea                	jne    76d <printf+0x4d>
      if(c == 'd'){
 783:	83 f8 25             	cmp    $0x25,%eax
 786:	0f 84 04 01 00 00    	je     890 <printf+0x170>
 78c:	83 e8 63             	sub    $0x63,%eax
 78f:	83 f8 15             	cmp    $0x15,%eax
 792:	77 1c                	ja     7b0 <printf+0x90>
 794:	ff 24 85 7c 0a 00 00 	jmp    *0xa7c(,%eax,4)
 ...
 813:	0f 84 87 00 00 00    	je     8a0 <printf+0x180>
        while(*s != 0){
 819:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
 81c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
 81e:	84 c0                	test   %al,%al
 820:	0f 84 47 ff ff ff    	je     76d <printf+0x4d>
 826:	8d 55 e7             	lea    -0x19(%ebp),%edx
 829:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 82c:	89 de                	mov    %ebx,%esi
 82e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
 ...
 851:	e9 17 ff ff ff       	jmp    76d <printf+0x4d>
        printint(fd, *ap, 10, 1);
 856:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 859:	83 ec 0c             	sub    $0xc,%esp
 85c:	b9 0a 00 00 00       	mov    $0xa,%ecx
 861:	8b 13                	mov    (%ebx),%edx
 863:	6a 01                	push   $0x1
 865:	eb 88                	jmp    7ef <printf+0xcf>
        putc(fd, *ap);
 867:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
 86a:	83 ec 04             	sub    $0x4,%esp
 86d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
 870:	8b 03                	mov    (%ebx),%eax
        ap++;
 872:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
 875:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 878:	6a 01                	push   $0x1
 87a:	52                   	push   %edx
 87b:	57                   	push   %edi
 87c:	e8 42 fd ff ff       	call   5c3 <write>
        ap++;
 881:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 884:	83 c4 10             	add    $0x10,%esp
      state = 0;
 887:	31 d2                	xor    %edx,%edx
 889:	e9 df fe ff ff       	jmp    76d <printf+0x4d>
 ...
 899:	6a 01                	push   $0x1
 89b:	e9 31 ff ff ff       	jmp    7d1 <printf+0xb1>
 8a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8a5:	bb 72 0a 00 00       	mov    $0xa72,%ebx
 8aa:	e9 77 ff ff ff       	jmp    826 <printf+0x106>
 8af:	90                   	nop
...
free(void *ap)
{
 ...
 8b1:	a1 28 0e 00 00       	mov    0xe28,%eax
{
 ...
 906:	72 ce                	jb     8d6 <free+0x26>
{
 ...
 927:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 92a:	a3 28 0e 00 00       	mov    %eax,0xe28
    p->s.size += bp->s.size;
 92f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 932:	8b 4b f8             	mov    -0x8(%ebx),%ecx
...
malloc(uint nbytes)
{
 ...
 949:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 94c:	8b 15 28 0e 00 00    	mov    0xe28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 98b:	3b 05 28 0e 00 00    	cmp    0xe28,%eax
 991:	75 ed                	jne    980 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 993:	83 ec 0c             	sub    $0xc,%esp
 996:	56                   	push   %esi
 997:	e8 8f fc ff ff       	call   62b <sbrk>
  if(p == (char*)-1)
 ...
 9ae:	e8 fd fe ff ff       	call   8b0 <free>
  return freep;
 9b3:	8b 15 28 0e 00 00    	mov    0xe28,%edx
 ...
 9dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9df:	89 15 28 0e 00 00    	mov    %edx,0xe28
}
 ...
 9ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 28 0e 00 00 2c 	movl   $0xe2c,0xe28
 9f7:	0e 00 00 
    base.s.size = 0;
 9fa:	b8 2c 0e 00 00       	mov    $0xe2c,%eax
    base.s.ptr = freep = prevp = &base;
 9ff:	c7 05 2c 0e 00 00 2c 	movl   $0xe2c,0xe2c
 a06:	0e 00 00 
    base.s.size = 0;
 a09:	c7 05 30 0e 00 00 00 	movl   $0x0,0xe30
 a10:	00 00 00 
    if(p->s.size >= nunits){
