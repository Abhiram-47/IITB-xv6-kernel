...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 21 01 00 00       	call   323 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 24 01 00 00       	call   33b <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 ea 00 00 00       	call   30b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 2bb:	e8 c0 03 00 00       	call   680 <malloc>
 ...
 2ca:	e8 b4 00 00 00       	call   383 <clone>
 2cf:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
  // ******************************
  // WPTHREAD -- END
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 3fb:	0f b6 92 d0 07 00 00 	movzbl 0x7d0(%edx),%edx
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4d4:	ff 24 85 78 07 00 00 	jmp    *0x778(,%eax,4)
 ...
 5e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5e5:	bb 71 07 00 00       	mov    $0x771,%ebx
