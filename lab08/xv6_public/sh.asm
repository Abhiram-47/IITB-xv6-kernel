...
fork1(void)
{
  ...
  exit();
      b2:	e8 8c 0d 00 00       	call   e43 <exit>
      close(fd);
      b7:	83 ec 0c             	sub    $0xc,%esp
      ba:	50                   	push   %eax
      bb:	e8 ab 0d 00 00       	call   e6b <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f5:	e8 b9 0d 00 00       	call   eb3 <chdir>
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 00 1a 00 00       	push   $0x1a00
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 00 1a 00 00       	push   $0x1a00
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 f8 19 00 00       	push   $0x19f8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 00 1a 00 00       	push   $0x1a00
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 00 1a 00 00       	push   $0x1a00
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 a0 13 00 00 	jmp    *0x13a0(,%eax,4)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d5d:	e8 21 01 00 00       	call   e83 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d71:	50                   	push   %eax
     d72:	e8 24 01 00 00       	call   e9b <fstat>
  close(fd);
     d77:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d7a:	89 c6                	mov    %eax,%esi
  close(fd);
     d7c:	e8 ea 00 00 00       	call   e6b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
  ...
  void* uva_stack = malloc(4096);
     e16:	68 00 10 00 00       	push   $0x1000
     e1b:	e8 c0 03 00 00       	call   11e0 <malloc>

  if ((thread_id = clone(fn, arg, uva_stack)) < 0)
     e20:	83 c4 0c             	add    $0xc,%esp
     e23:	50                   	push   %eax
     e24:	ff 75 0c             	push   0xc(%ebp)
     e27:	ff 75 08             	push   0x8(%ebp)
     e2a:	e8 b4 00 00 00       	call   ee3 <clone>
     e2f:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
  // ******************************
  // WPTHREAD -- END
     ...
     f28:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f96:	50                   	push   %eax
     f97:	56                   	push   %esi
     f98:	e8 c6 fe ff ff       	call   e63 <write>
  while(--i >= 0)
     ...
     fc9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    1000:	50                   	push   %eax
    1001:	57                   	push   %edi
    1002:	e8 5c fe ff ff       	call   e63 <write>
  ...
  write(fd, &c, 1);
    ...
    1071:	52                   	push   %edx
    1072:	57                   	push   %edi
    1073:	e8 eb fd ff ff       	call   e63 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10db:	53                   	push   %ebx
    10dc:	57                   	push   %edi
    10dd:	e8 81 fd ff ff       	call   e63 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    111a:	52                   	push   %edx
    111b:	57                   	push   %edi
    111c:	e8 42 fd ff ff       	call   e63 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1236:	56                   	push   %esi
    1237:	e8 8f fc ff ff       	call   ecb <sbrk>
  if(p == (char*)-1)
