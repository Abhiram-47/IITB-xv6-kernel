...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 36b:	e8 c0 03 00 00       	call   730 <malloc>
 ...
 6a1:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 68 0b 00 00    	mov    0xb68,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 68 0b 00 00    	cmp    0xb68,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 68 0b 00 00    	mov    0xb68,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 ...
 7df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 6c 0b 00 00       	mov    $0xb6c,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 7f6:	0b 00 00 
    base.s.size = 0;
 7f9:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 800:	00 00 00 
    if(p->s.size >= nunits){
