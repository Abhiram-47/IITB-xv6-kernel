...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 5eb:	e8 c0 03 00 00       	call   9b0 <malloc>
 ...
 6f8:	89 d1                	mov    %edx,%ecx
{
 ...
 766:	50                   	push   %eax
 767:	56                   	push   %esi
 768:	e8 c6 fe ff ff       	call   633 <write>
  while(--i >= 0)
 ...
 799:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7d0:	50                   	push   %eax
 7d1:	57                   	push   %edi
 7d2:	e8 5c fe ff ff       	call   633 <write>
 ...
 841:	52                   	push   %edx
 842:	57                   	push   %edi
 843:	e8 eb fd ff ff       	call   633 <write>
        putc(fd, c);
 ...
 8ea:	52                   	push   %edx
 8eb:	57                   	push   %edi
 8ec:	e8 42 fd ff ff       	call   633 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 a06:	56                   	push   %esi
 a07:	e8 8f fc ff ff       	call   69b <sbrk>
  if(p == (char*)-1)
