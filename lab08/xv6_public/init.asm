...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 33b:	e8 c0 03 00 00       	call   700 <malloc>
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 660:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 665:	bb 38 08 00 00       	mov    $0x838,%ebx
 ...
 671:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 6af:	5b                   	pop    %ebx
  freep = p;
 6b0:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 6b7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 60 0b 00 00    	mov    0xb60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74b:	3b 05 60 0b 00 00    	cmp    0xb60,%eax
 ...
 76e:	e8 fd fe ff ff       	call   670 <free>
  return freep;
 773:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 64 0b 00 00       	mov    $0xb64,%eax
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 7c6:	0b 00 00 
    base.s.size = 0;
 7c9:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 7d0:	00 00 00 
    if(p->s.size >= nunits){
