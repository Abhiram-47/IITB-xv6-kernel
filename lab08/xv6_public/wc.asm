...
main(int argc, char *argv[])
{
  ...
  44:	e8 d2 03 00 00       	call   41b <close>
  for(i = 1; i < argc; i++){
  ...
  54:	6a 00                	push   $0x0
  56:	ff 33                	push   (%ebx)
  58:	e8 d6 03 00 00       	call   433 <open>
  ...
  66:	50                   	push   %eax
  67:	ff 33                	push   (%ebx)
  69:	68 9b 08 00 00       	push   $0x89b
  6e:	6a 01                	push   $0x1
  70:	e8 fb 04 00 00       	call   570 <printf>
      exit();
  75:	e8 79 03 00 00       	call   3f3 <exit>
  }
  exit();
...
stat(const char *n, struct stat *st)
{
 ...
 30d:	e8 21 01 00 00       	call   433 <open>
  if(fd < 0)
 ...
 321:	50                   	push   %eax
 322:	e8 24 01 00 00       	call   44b <fstat>
  close(fd);
 327:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 32a:	89 c6                	mov    %eax,%esi
  close(fd);
 32c:	e8 ea 00 00 00       	call   41b <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 3c6:	68 00 10 00 00       	push   $0x1000
 3cb:	e8 c0 03 00 00       	call   790 <malloc>

  if ((thread_id = clone(fn, arg, uva_stack)) < 0)
 3d0:	83 c4 0c             	add    $0xc,%esp
 3d3:	50                   	push   %eax
 3d4:	ff 75 0c             	push   0xc(%ebp)
 3d7:	ff 75 08             	push   0x8(%ebp)
 3da:	e8 b4 00 00 00       	call   493 <clone>
 3df:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
  // ******************************
  // WPTHREAD -- END
 ...
 4d8:	89 d1                	mov    %edx,%ecx
{
 ...
 50b:	0f b6 92 10 09 00 00 	movzbl 0x910(%edx),%edx
 ...
 546:	50                   	push   %eax
 547:	56                   	push   %esi
 548:	e8 c6 fe ff ff       	call   413 <write>
  while(--i >= 0)
 ...
 579:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5b0:	50                   	push   %eax
 5b1:	57                   	push   %edi
 5b2:	e8 5c fe ff ff       	call   413 <write>
 ...
 5e4:	ff 24 85 b8 08 00 00 	jmp    *0x8b8(,%eax,4)
 ...
 621:	52                   	push   %edx
 622:	57                   	push   %edi
 623:	e8 eb fd ff ff       	call   413 <write>
        putc(fd, c);
 ...
 6ca:	52                   	push   %edx
 6cb:	57                   	push   %edi
 6cc:	e8 42 fd ff ff       	call   413 <write>
        ap++;
 ...
 6f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6f5:	bb af 08 00 00       	mov    $0x8af,%ebx
 ...
 701:	a1 20 0e 00 00       	mov    0xe20,%eax
{
 ...
 73f:	5b                   	pop    %ebx
  freep = p;
 740:	a3 20 0e 00 00       	mov    %eax,0xe20
}
 745:	5e                   	pop    %esi
 746:	5f                   	pop    %edi
 747:	5d                   	pop    %ebp
 ...
 756:	72 ce                	jb     726 <free+0x26>
{
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 20 0e 00 00       	mov    %eax,0xe20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 20 0e 00 00    	mov    0xe20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7db:	3b 05 20 0e 00 00    	cmp    0xe20,%eax
 7e1:	75 ed                	jne    7d0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7e3:	83 ec 0c             	sub    $0xc,%esp
 7e6:	56                   	push   %esi
 7e7:	e8 8f fc ff ff       	call   47b <sbrk>
  if(p == (char*)-1)
 ...
 7fe:	e8 fd fe ff ff       	call   700 <free>
  return freep;
 803:	8b 15 20 0e 00 00    	mov    0xe20,%edx
 ...
 83f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 20 0e 00 00 24 	movl   $0xe24,0xe20
 847:	0e 00 00 
    base.s.size = 0;
 84a:	b8 24 0e 00 00       	mov    $0xe24,%eax
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 24 0e 00 00 24 	movl   $0xe24,0xe24
 856:	0e 00 00 
    base.s.size = 0;
 859:	c7 05 28 0e 00 00 00 	movl   $0x0,0xe28
 860:	00 00 00 
    if(p->s.size >= nunits){
