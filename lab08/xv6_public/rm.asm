...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 ff 02 00 00       	call   343 <unlink>
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 2cb:	e8 c0 03 00 00       	call   690 <malloc>
 ...
 3d8:	89 d1                	mov    %edx,%ecx
{
 ...
 40b:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
 ...
 479:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e4:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
