...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 2ab:	e8 c0 03 00 00       	call   670 <malloc>
 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4c4:	ff 24 85 74 07 00 00 	jmp    *0x774(,%eax,4)
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 6c 07 00 00       	mov    $0x76c,%ebx
