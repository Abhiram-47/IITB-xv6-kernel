...
_tc-semaphore:     file format elf32-i386
...
int main(int argc, char *argv[]) {
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	83 ec 68             	sub    $0x68,%esp

    sem = semaphore_init(1);
  13:	6a 01                	push   $0x1
  15:	e8 19 04 00 00       	call   433 <semaphore_init>
    int N = 20;
    printf(1, "Calling Process Print VAR value: %d, N: %d\n", VAR, N);
  1a:	6a 14                	push   $0x14
  1c:	ff 35 9c 0b 00 00    	push   0xb9c
  22:	68 08 08 00 00       	push   $0x808
  27:	6a 01                	push   $0x1
    sem = semaphore_init(1);
  29:	a3 98 0b 00 00       	mov    %eax,0xb98
    printf(1, "Calling Process Print VAR value: %d, N: %d\n", VAR, N);
  2e:	e8 cd 04 00 00       	call   500 <printf>
  33:	83 c4 20             	add    $0x20,%esp
  ...
  3f:	00 
        ind[i]=i;
  40:	89 44 85 98          	mov    %eax,-0x68(%ebp,%eax,4)
    for(int i=0;i<N;i++)
  44:	8d 50 01             	lea    0x1(%eax),%edx
  47:	83 c0 02             	add    $0x2,%eax
        ind[i]=i;
  4a:	89 54 95 98          	mov    %edx,-0x68(%ebp,%edx,4)
    for(int i=0;i<N;i++)
  4e:	83 f8 14             	cmp    $0x14,%eax
  51:	75 ed                	jne    40 <main+0x40>
  53:	8d 5d 98             	lea    -0x68(%ebp),%ebx
  56:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  64:	83 c3 04             	add    $0x4,%ebx
        create_thread(increment, &ind[i]);
  67:	68 c0 00 00 00       	push   $0xc0
  6c:	e8 df 02 00 00       	call   350 <create_thread>
    for(int i=0;i<N;i++) {
  71:	83 c4 10             	add    $0x10,%esp
  74:	39 f3                	cmp    %esi,%ebx
  76:	75 e8                	jne    60 <main+0x60>
  78:	bb 14 00 00 00       	mov    $0x14,%ebx
  7d:	8d 76 00             	lea    0x0(%esi),%esi
    }

    for(int i=0;i<N;i++) {
        join();
  80:	e8 a6 03 00 00       	call   42b <join>
  85:	e8 a1 03 00 00       	call   42b <join>
    for(int i=0;i<N;i++) {
  ...
  92:	ff 35 9c 0b 00 00    	push   0xb9c
  98:	68 34 08 00 00       	push   $0x834
  9d:	6a 01                	push   $0x1
  9f:	e8 5c 04 00 00       	call   500 <printf>
    semaphore_destroy(sem);
  a4:	58                   	pop    %eax
  a5:	ff 35 98 0b 00 00    	push   0xb98
  ab:	e8 8b 03 00 00       	call   43b <semaphore_destroy>
    exit();
  b0:	e8 ce 02 00 00       	call   383 <exit>
  b5:	66 90                	xchg   %ax,%ax
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
...
void increment(int *thread_rank) {
  ...
  c4:	83 ec 10             	sub    $0x10,%esp
    semaphore_down(sem);
  c7:	ff 35 98 0b 00 00    	push   0xb98
  cd:	e8 71 03 00 00       	call   443 <semaphore_down>
    sleep(10);
  d2:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
    int tmp = VAR;
  d9:	8b 1d 9c 0b 00 00    	mov    0xb9c,%ebx
    sleep(10);
  df:	e8 2f 03 00 00       	call   413 <sleep>
    sleep(10);
  e4:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  eb:	e8 23 03 00 00       	call   413 <sleep>
    semaphore_up(sem);
  f0:	58                   	pop    %eax
  f1:	ff 35 98 0b 00 00    	push   0xb98
    tmp++;
  f7:	83 c3 01             	add    $0x1,%ebx
  fa:	89 1d 9c 0b 00 00    	mov    %ebx,0xb9c
    semaphore_up(sem);
 100:	e8 46 03 00 00       	call   44b <semaphore_up>
    exit();
 105:	e8 79 02 00 00       	call   383 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 29d:	e8 21 01 00 00       	call   3c3 <open>
  if(fd < 0)
 ...
 2b1:	50                   	push   %eax
 2b2:	e8 24 01 00 00       	call   3db <fstat>
  close(fd);
 2b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ba:	89 c6                	mov    %eax,%esi
  close(fd);
 2bc:	e8 ea 00 00 00       	call   3ab <close>
  return r;
...
int create_thread(void(*fn)(int*), int *arg)
{
 ...
 356:	68 00 10 00 00       	push   $0x1000
 35b:	e8 c0 03 00 00       	call   720 <malloc>
 ...
 36a:	e8 b4 00 00 00       	call   423 <clone>
 36f:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    return -1;
  return thread_id;
  // ******************************
  // WPTHREAD -- END
 ...
 468:	89 d1                	mov    %edx,%ecx
{
 ...
 49b:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
 ...
 4d6:	50                   	push   %eax
 4d7:	56                   	push   %esi
 4d8:	e8 c6 fe ff ff       	call   3a3 <write>
  while(--i >= 0)
 ...
 509:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 540:	50                   	push   %eax
 541:	57                   	push   %edi
 542:	e8 5c fe ff ff       	call   3a3 <write>
 ...
 574:	ff 24 85 60 08 00 00 	jmp    *0x860(,%eax,4)
 ...
 5b1:	52                   	push   %edx
 5b2:	57                   	push   %edi
 5b3:	e8 eb fd ff ff       	call   3a3 <write>
        putc(fd, c);
 ...
 65a:	52                   	push   %edx
 65b:	57                   	push   %edi
 65c:	e8 42 fd ff ff       	call   3a3 <write>
        ap++;
 ...
 680:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 685:	bb 57 08 00 00       	mov    $0x857,%ebx
 ...
 691:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6cf:	5b                   	pop    %ebx
  freep = p;
 6d0:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 6d7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 76b:	3b 05 a0 0b 00 00    	cmp    0xba0,%eax
 771:	75 ed                	jne    760 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 773:	83 ec 0c             	sub    $0xc,%esp
 776:	56                   	push   %esi
 777:	e8 8f fc ff ff       	call   40b <sbrk>
  if(p == (char*)-1)
 ...
 78e:	e8 fd fe ff ff       	call   690 <free>
  return freep;
 793:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 a4 0b 00 00       	mov    $0xba4,%eax
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 7e6:	0b 00 00 
    base.s.size = 0;
 7e9:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 7f0:	00 00 00 
    if(p->s.size >= nunits){
