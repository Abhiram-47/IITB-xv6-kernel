  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1c:	e8 ca 03 00 00       	call   3eb <uptime>
  ...
  27:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    int n = atoi(argv[1]);
  2a:	e8 b1 02 00 00       	call   2e0 <atoi>
  ...
  5e:	66 90                	xchg   %ax,%ax
                ...
                acquiresleeplk();
  60:	e8 a6 03 00 00       	call   40b <acquiresleeplk>
                int temp = *counter;
                sleep(1);
  65:	83 ec 0c             	sub    $0xc,%esp
                int temp = *counter;
  68:	8b 1f                	mov    (%edi),%ebx
                sleep(1);
  6a:	6a 01                	push   $0x1
                temp=temp+1;
  6c:	83 c3 01             	add    $0x1,%ebx
                sleep(1);
  6f:	e8 6f 03 00 00       	call   3e3 <sleep>
                temp=temp+1;
  74:	89 1f                	mov    %ebx,(%edi)
                *counter=temp;
                releasesleeplk();
  76:	e8 98 03 00 00       	call   413 <releasesleeplk>
            for(int j=0;j<10;j++){
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	83 ee 01             	sub    $0x1,%esi
  ...
  88:	52                   	push   %edx
  89:	52                   	push   %edx
  8a:	68 c8 07 00 00       	push   $0x7c8
  8f:	6a 01                	push   $0x1
  91:	e8 2a 04 00 00       	call   4c0 <printf>
        exit();
  96:	e8 b8 02 00 00       	call   353 <exit>
        }
    }

    int* final=(int*)(smalloc());
  9b:	e8 53 03 00 00       	call   3f3 <smalloc>

    for(int i=0;i<n;i++){
  a0:	31 ff                	xor    %edi,%edi
    int* final=(int*)(smalloc());
  a2:	89 45 e0             	mov    %eax,-0x20(%ebp)
    for(int i=0;i<n;i++){
  a5:	8d 76 00             	lea    0x0(%esi),%esi

        wait();
  a8:	e8 ae 02 00 00       	call   35b <wait>
    for(int i=0;i<n;i++){
  ad:	89 f8                	mov    %edi,%eax
  af:	83 c7 01             	add    $0x1,%edi
  b2:	39 c3                	cmp    %eax,%ebx
  b4:	75 f2                	jne    a8 <main+0xa8>
    }
  ...
  ba:	6b f6 0a             	imul   $0xa,%esi,%esi
    printf(1,"Actual Count: %d\n",*final);
  bd:	ff 30                	push   (%eax)
  bf:	68 ec 07 00 00       	push   $0x7ec
  c4:	6a 01                	push   $0x1
  c6:	e8 f5 03 00 00       	call   4c0 <printf>
    printf(1,"Expected Count: %d\n",n*10);
  cb:	83 c4 0c             	add    $0xc,%esp
  ce:	56                   	push   %esi
  cf:	68 fe 07 00 00       	push   $0x7fe
  d4:	6a 01                	push   $0x1
  d6:	e8 e5 03 00 00       	call   4c0 <printf>
    int final_time=uptime();
  db:	e8 0b 03 00 00       	call   3eb <uptime>
  ...
  e8:	50                   	push   %eax
  e9:	68 12 08 00 00       	push   $0x812
  ee:	6a 01                	push   $0x1
  f0:	e8 cb 03 00 00       	call   4c0 <printf>
    exit();
  f5:	e8 59 02 00 00       	call   353 <exit>
    int* final=(int*)(smalloc());
  fa:	e8 f4 02 00 00       	call   3f3 <smalloc>
  ff:	89 45 e0             	mov    %eax,-0x20(%ebp)
    for(int i=0;i<n;i++){
 102:	eb b2                	jmp    b6 <main+0xb6>
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 534:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb 29 08 00 00       	mov    $0x829,%ebx
 ...
 651:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 30 0b 00 00    	mov    0xb30,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 30 0b 00 00    	cmp    0xb30,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 34 0b 00 00       	mov    $0xb34,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 7b0:	00 00 00 
    if(p->s.size >= nunits){
