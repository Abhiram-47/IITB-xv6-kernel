  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1c:	e8 aa 03 00 00       	call   3cb <uptime>
  ...
  27:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    int n = atoi(argv[1]);
  2a:	e8 91 02 00 00       	call   2c0 <atoi>
  ...
  92:	e8 3c 03 00 00       	call   3d3 <smalloc>
  ...
  9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        ...
        wait();
  a0:	e8 96 02 00 00       	call   33b <wait>
    for(int i=0;i<n;i++){
  ...
  ae:	8b 1e                	mov    (%esi),%ebx
  b0:	e8 fe 02 00 00       	call   3b3 <getpid>
  b5:	83 ec 0c             	sub    $0xc,%esp
  b8:	53                   	push   %ebx
  b9:	56                   	push   %esi
  ba:	50                   	push   %eax
  bb:	68 f0 07 00 00       	push   $0x7f0
  c0:	6a 01                	push   $0x1
  c2:	e8 d9 03 00 00       	call   4a0 <printf>
    int final_time=uptime();
  c7:	83 c4 20             	add    $0x20,%esp
  ca:	e8 fc 02 00 00       	call   3cb <uptime>
  ...
  d5:	50                   	push   %eax
  d6:	68 12 08 00 00       	push   $0x812
  db:	6a 01                	push   $0x1
  dd:	e8 be 03 00 00       	call   4a0 <printf>
    exit();
  e2:	e8 4c 02 00 00       	call   333 <exit>
    int* final=(int*)(smalloc());
  e7:	e8 e7 02 00 00       	call   3d3 <smalloc>
  ec:	89 c6                	mov    %eax,%esi
    for(int i=0;i<n;i++){
  ee:	eb be                	jmp    ae <main+0xae>
 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb 29 08 00 00       	mov    $0x829,%ebx
