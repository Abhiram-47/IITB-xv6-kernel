     ...
     f79:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    10ca:	52                   	push   %edx
    10cb:	57                   	push   %edi
    10cc:	e8 52 fd ff ff       	call   e23 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11e6:	56                   	push   %esi
    11e7:	e8 9f fc ff ff       	call   e8b <sbrk>
  if(p == (char*)-1)
